...
All history information can be found at [Github History](https://github.com/trueforge-org/truecharts/commits/master/charts//socket-proxy)
...
- fix(deps): update linuxserver/docker-socket-proxy 3.2.8-r0 → 3.2.13-r0-ls70 (#1543) • [`db2903f`](https://github.com/trueforge-org/truecharts/commit/db2903f74cccb6cb41b8f6f5bb0539170c20df25) • [@TrueCharts Bot] (2026-02-24)
