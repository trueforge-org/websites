...
services:
    ...
    deploy:
      resources:
        limits:
          ...
          memory: 4G
    environment:
      HISHTORY_POSTGRES_DB: postgresql://hishtory-server:05388586e75dcc0a525846868bf30589WORD@postgresql:5432/hishtory-server
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: 05388586e75dcc0a525846868bf30589WORD
