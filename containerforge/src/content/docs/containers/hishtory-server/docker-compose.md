...
services:
    ...
    deploy:
      resources:
        limits:
          ...
          memory: 4G
    environment:
      HISHTORY_POSTGRES_DB: postgresql://hishtory-server:83b874bb4df021de5afd03bb4b0727c2WORD@postgresql:5432/hishtory-server
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: 83b874bb4df021de5afd03bb4b0727c2WORD
