...
services:
    ...
    deploy:
      resources:
        limits:
          ...
          memory: 4G
    environment:
      HISHTORY_POSTGRES_DB: postgresql://hishtory-server:457d7fbe727554fa58c9fa54321c4a61WORD@postgresql:5432/hishtory-server
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: 457d7fbe727554fa58c9fa54321c4a61WORD
