...
services:
    ...
    deploy:
      resources:
        limits:
          ...
          memory: 4G
    environment:
      HISHTORY_POSTGRES_DB: postgresql://hishtory-server:bd6713c844aad755054010d3fb7707b3WORD@postgresql:5432/hishtory-server
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: bd6713c844aad755054010d3fb7707b3WORD
