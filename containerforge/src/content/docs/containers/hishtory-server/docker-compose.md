...
services:
    ...
    deploy:
      resources:
        limits:
          ...
          memory: 4G
    environment:
      HISHTORY_POSTGRES_DB: postgresql://hishtory-server:786d3197f35ee4a692e811f258cfbd92WORD@postgresql:5432/hishtory-server
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: 786d3197f35ee4a692e811f258cfbd92WORD
