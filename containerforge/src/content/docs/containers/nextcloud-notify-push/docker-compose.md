...
services:
  nextcloud-fpm:
    ...
    environment:
      ...
      NX_POSTGRES_PASSWORD: 6ce8229c9d4a1f994d6626e1d7f06660WORD
      NX_POSTGRES_PORT: "5432"
      NX_POSTGRES_USER: nextcloud-notify-push
      NX_REDIS_HOST: valkey
      NX_REDIS_PASS: 4fdb328fd4fa821627da42dc7d633f02WORD
      NX_REDIS_PORT: "6379"
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  nextcloud-notify-push:
    ...
    group_add:
      - "568"
    image: ghcr.io/trueforge-org/nextcloud-notify-push:1.4.1
    restart: unless-stopped
    shm_size: 256M
    volumes:
      - type: bind
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: 6ce8229c9d4a1f994d6626e1d7f06660WORD
  ...
  valkey:
    ...
    environment:
      TZ: Etc/UTC
      VALKEY_PASSWORD: 4fdb328fd4fa821627da42dc7d633f02WORD
    group_add:
      - "568"
