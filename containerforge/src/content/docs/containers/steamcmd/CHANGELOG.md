...
All history information can be found at [Github History](https://github.com/trueforge-org/truecharts/commits/master/charts//steamcmd)
...
- fix(ci): repair release builds broken by Ubuntu 26.04 base image bump (#2293) • [`537b9bc`](https://github.com/trueforge-org/truecharts/commit/537b9bc0a3c4bb59f806759a5a39e934f23ce995) • [@Copilot] (2026-05-07)
...
- chore(ubuntu-dep): update ghcr.io/trueforge-org/ubuntu:24.4.0 docker digest digest to 36c48bc (#1461) • [`d7d2f63`](https://github.com/trueforge-org/truecharts/commit/d7d2f63d9511287086034b2ac2f2e045828cf4d8) • [@TrueCharts Bot] (2026-02-20)
...
- Add rootless `steamcmd` base image under `apps/steamcmd` with apt-based install, renovate-compatible version pinning, `/config` runtime seeding, hardened runtime init flow, and readonly-rootfs compatibility (#1415) • [`474b04b`](https://github.com/trueforge-org/truecharts/commit/474b04b7cd501d0318e8568b5d0c8ad9e2032b7e) • [@Copilot] (2026-02-20)
