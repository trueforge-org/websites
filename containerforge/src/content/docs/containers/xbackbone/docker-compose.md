...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ca4750ad7c4b9423a67e622022b358e9WORD
      MARIADB_ROOT_PASSWORD: cd752e4f85d66a5142b9e9655f5332e4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ca4750ad7c4b9423a67e622022b358e9WORD
      DB_PORT: "3306"
