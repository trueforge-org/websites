...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3ccecf90b0d5c001bca875cfd5d266b1WORD
      MARIADB_ROOT_PASSWORD: 78bf4cb15d8698d1a8807ed5b8098258WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3ccecf90b0d5c001bca875cfd5d266b1WORD
      DB_PORT: "3306"
