...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d9487adea041c33f7a9a06db4b8f4ed1WORD
      MARIADB_ROOT_PASSWORD: ec7349c3c90d23d31f441e48b458ce32WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d9487adea041c33f7a9a06db4b8f4ed1WORD
      DB_PORT: "3306"
