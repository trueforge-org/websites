...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bcc0c982e70f663435f9e9448b9dc57fWORD
      MARIADB_ROOT_PASSWORD: 5c8240023d3a5d5bd3e179bb05fe669cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bcc0c982e70f663435f9e9448b9dc57fWORD
      DB_PORT: "3306"
