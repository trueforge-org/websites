...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5bc371821caea20fce17a84fb4be2d61WORD
      MARIADB_ROOT_PASSWORD: b773bc101031f084ccb9fedfb3616bcaWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5bc371821caea20fce17a84fb4be2d61WORD
      DB_PORT: "3306"
