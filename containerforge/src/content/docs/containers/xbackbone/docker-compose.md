...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8ccc7306f3072c11de5bc3fd97bdc919WORD
      MARIADB_ROOT_PASSWORD: f29310d93863cb982f8b9591d37e148eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8ccc7306f3072c11de5bc3fd97bdc919WORD
      DB_PORT: "3306"
