...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c5bd26f6a9f9ddbc1e7e7376b06576cdWORD
      MARIADB_ROOT_PASSWORD: c875b53e458a9df3bb133683bc839c70WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c5bd26f6a9f9ddbc1e7e7376b06576cdWORD
      DB_PORT: "3306"
