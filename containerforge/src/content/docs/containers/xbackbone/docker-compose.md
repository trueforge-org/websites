...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 172762b356da2385f918e49cfce9eebaWORD
      MARIADB_ROOT_PASSWORD: f73561f8c63915fad4812cac6bec5c9dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 172762b356da2385f918e49cfce9eebaWORD
      DB_PORT: "3306"
