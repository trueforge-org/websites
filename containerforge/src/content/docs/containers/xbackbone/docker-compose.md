...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 34a5c3b4215c8b1bb74aceef78610164WORD
      MARIADB_ROOT_PASSWORD: 96fb0da3ac3b0028f002d73be187c58cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 34a5c3b4215c8b1bb74aceef78610164WORD
      DB_PORT: "3306"
