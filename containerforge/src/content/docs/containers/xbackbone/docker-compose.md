...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d6464214a228af2e3f6b0e934b93bd9eWORD
      MARIADB_ROOT_PASSWORD: a5f76940d72f80611a5327a51c10374cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d6464214a228af2e3f6b0e934b93bd9eWORD
      DB_PORT: "3306"
