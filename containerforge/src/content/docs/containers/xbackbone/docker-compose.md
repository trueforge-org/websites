...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 697ea9db5833929f47879b19d53cd778WORD
      MARIADB_ROOT_PASSWORD: 8e60adeb413aa7eee55607fd30c8f9b6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 697ea9db5833929f47879b19d53cd778WORD
      DB_PORT: "3306"
