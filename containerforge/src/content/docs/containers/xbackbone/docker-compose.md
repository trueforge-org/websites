...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 055c930a78bd34fb76fe92448cf9b4dfWORD
      MARIADB_ROOT_PASSWORD: fa7d3bc42658082d8a1dc73ab312e12fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 055c930a78bd34fb76fe92448cf9b4dfWORD
      DB_PORT: "3306"
