...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3f067ee679dc31e3a2d0cd1440cdc5eaWORD
      MARIADB_ROOT_PASSWORD: 5c545607b95a21912f35c911eef17f8dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3f067ee679dc31e3a2d0cd1440cdc5eaWORD
      DB_PORT: "3306"
