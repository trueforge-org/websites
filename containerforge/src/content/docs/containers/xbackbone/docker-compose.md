...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 94e9180a1ff13d15188d44659aed3698WORD
      MARIADB_ROOT_PASSWORD: d08664a00142294cd2d844f12e343dc1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 94e9180a1ff13d15188d44659aed3698WORD
      DB_PORT: "3306"
