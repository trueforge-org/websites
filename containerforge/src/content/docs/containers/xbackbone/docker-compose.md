...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9a76a95ebd18b1155d74dcca143ba3a5WORD
      MARIADB_ROOT_PASSWORD: 742ed1b2bd3da3b67464964eaa91a1dbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9a76a95ebd18b1155d74dcca143ba3a5WORD
      DB_PORT: "3306"
