...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 95a40cf7609664665a765f661843178fWORD
      MARIADB_ROOT_PASSWORD: 10439275eca2a27e00c70d437e408559WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 95a40cf7609664665a765f661843178fWORD
      DB_PORT: "3306"
