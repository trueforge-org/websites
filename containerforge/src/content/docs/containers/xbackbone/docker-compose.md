...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 23fa39d3a4a13f41f24069b0771ac4c9WORD
      MARIADB_ROOT_PASSWORD: a56d37f5775beca81620e28970d44daaWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 23fa39d3a4a13f41f24069b0771ac4c9WORD
      DB_PORT: "3306"
