...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5f8ed433ada80ca99b27bd959a6b2c51WORD
      MARIADB_ROOT_PASSWORD: 5ff63fed4101621f332c154692786f24WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5f8ed433ada80ca99b27bd959a6b2c51WORD
      DB_PORT: "3306"
