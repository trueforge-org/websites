...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a0a4647b1654e3cd6c4e425d331bfb0fWORD
      MARIADB_ROOT_PASSWORD: 8e6be7f51be7542172229a2988a44049WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a0a4647b1654e3cd6c4e425d331bfb0fWORD
      DB_PORT: "3306"
