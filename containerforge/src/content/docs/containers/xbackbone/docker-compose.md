...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 78210672a4891de87f933f194d8b6e61WORD
      MARIADB_ROOT_PASSWORD: 2038cfd01c267bc38f900b78c8e645d0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 78210672a4891de87f933f194d8b6e61WORD
      DB_PORT: "3306"
