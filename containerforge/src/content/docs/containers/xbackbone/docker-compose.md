...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bb4e308712abaa988b6155eaff0ead2eWORD
      MARIADB_ROOT_PASSWORD: f3333f5ddc720e987092445e63eb7922WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bb4e308712abaa988b6155eaff0ead2eWORD
      DB_PORT: "3306"
