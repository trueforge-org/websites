...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a450afed0d4c192b6985e6dc8becc624WORD
      MARIADB_ROOT_PASSWORD: 48e57dd244fe5affa533f2aab4f0311aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a450afed0d4c192b6985e6dc8becc624WORD
      DB_PORT: "3306"
