...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 45898168f490e943af57bc95940e60ddWORD
      MARIADB_ROOT_PASSWORD: 6d94f4a39d4076369d48bbf0a6762cf2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 45898168f490e943af57bc95940e60ddWORD
      DB_PORT: "3306"
