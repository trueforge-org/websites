...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 080f53083eb80465609d724456765362WORD
      MARIADB_ROOT_PASSWORD: c0ee68563416f037e971b9f67118138eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 080f53083eb80465609d724456765362WORD
      DB_PORT: "3306"
