...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c6259a847c592b533cb8e20cd6c6f1ecWORD
      MARIADB_ROOT_PASSWORD: fb94ceb9c69a850cd7cc21724085c2e8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c6259a847c592b533cb8e20cd6c6f1ecWORD
      DB_PORT: "3306"
