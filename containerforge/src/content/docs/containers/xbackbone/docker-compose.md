...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2af400cd10f0fe222559f1bb4e0a40aeWORD
      MARIADB_ROOT_PASSWORD: 9aacadb03ee015f138b448b41bd41eedWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2af400cd10f0fe222559f1bb4e0a40aeWORD
      DB_PORT: "3306"
