...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 93a5a535ec94f14b038ed829e94daff7WORD
      MARIADB_ROOT_PASSWORD: 1844ad82193f94ca60ba5c522619dd68WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 93a5a535ec94f14b038ed829e94daff7WORD
      DB_PORT: "3306"
