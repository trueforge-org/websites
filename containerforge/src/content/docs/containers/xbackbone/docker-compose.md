...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 59eab57c72b06899d72c55d2ac8a089bWORD
      MARIADB_ROOT_PASSWORD: f74311722600f52980765f2dfb212e18WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 59eab57c72b06899d72c55d2ac8a089bWORD
      DB_PORT: "3306"
