...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4d0d63045cff4015889f0233e36810daWORD
      MARIADB_ROOT_PASSWORD: 3f248fb9b0777181aec8e75360573b21WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4d0d63045cff4015889f0233e36810daWORD
      DB_PORT: "3306"
