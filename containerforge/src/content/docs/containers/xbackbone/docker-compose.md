...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6ce1a9a1c2b643df106127367c1fdc70WORD
      MARIADB_ROOT_PASSWORD: 1d4305f0793d5ab97825c0deb10832b4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6ce1a9a1c2b643df106127367c1fdc70WORD
      DB_PORT: "3306"
