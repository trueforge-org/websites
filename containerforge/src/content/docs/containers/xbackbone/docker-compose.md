...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fcde21a4e0fae4591d1dfd2a3b4265efWORD
      MARIADB_ROOT_PASSWORD: ea7d306fb168ae36bdffa060e2e35ab8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fcde21a4e0fae4591d1dfd2a3b4265efWORD
      DB_PORT: "3306"
