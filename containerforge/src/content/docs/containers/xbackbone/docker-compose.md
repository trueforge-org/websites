...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4160cb802db2ff95b89145b78d901233WORD
      MARIADB_ROOT_PASSWORD: bd1f909e41878aa5392640ed8c9bf545WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4160cb802db2ff95b89145b78d901233WORD
      DB_PORT: "3306"
