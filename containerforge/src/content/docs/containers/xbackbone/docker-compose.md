...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4e74aa5cc496ba18d639988cdca99f09WORD
      MARIADB_ROOT_PASSWORD: 38f00852a93c8a8e2873266976f22f98WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4e74aa5cc496ba18d639988cdca99f09WORD
      DB_PORT: "3306"
