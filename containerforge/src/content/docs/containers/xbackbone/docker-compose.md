...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4b2d5c15b62bee477e22e43472aa2540WORD
      MARIADB_ROOT_PASSWORD: 90d028d002580cfe75c6efc3b6a9d2b2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4b2d5c15b62bee477e22e43472aa2540WORD
      DB_PORT: "3306"
