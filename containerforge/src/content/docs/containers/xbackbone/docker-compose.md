...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 888a95f925663919edbc054457d07c34WORD
      MARIADB_ROOT_PASSWORD: edadc8bafe280d85579d547143cb0c69WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 888a95f925663919edbc054457d07c34WORD
      DB_PORT: "3306"
