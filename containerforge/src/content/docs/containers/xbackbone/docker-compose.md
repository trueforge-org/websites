...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7bbfce7a7bfb5a53d0a3b4cd4885edd1WORD
      MARIADB_ROOT_PASSWORD: 9bbb823157c157c978ed229295819e09WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7bbfce7a7bfb5a53d0a3b4cd4885edd1WORD
      DB_PORT: "3306"
