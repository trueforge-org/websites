...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1713decf6cfca06c86bfd6b5c95a9a6cWORD
      MARIADB_ROOT_PASSWORD: 2a2bbf0405f715691316474383993a55WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1713decf6cfca06c86bfd6b5c95a9a6cWORD
      DB_PORT: "3306"
