...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d58a75d438dd62342ac23fae087f2a61WORD
      MARIADB_ROOT_PASSWORD: e6907caeac4a2675d9e89f4cdbf68a2bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d58a75d438dd62342ac23fae087f2a61WORD
      DB_PORT: "3306"
