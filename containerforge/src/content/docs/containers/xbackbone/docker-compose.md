...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 049190f694ca6a6d104a3b2c05c72f98WORD
      MARIADB_ROOT_PASSWORD: 9263845dcbeb066b9b9783736eb6d0caWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 049190f694ca6a6d104a3b2c05c72f98WORD
      DB_PORT: "3306"
