...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2e2eb255158530d6c0c0670bd328eae1WORD
      MARIADB_ROOT_PASSWORD: f6d99111490f2618349b5a5b874971e6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2e2eb255158530d6c0c0670bd328eae1WORD
      DB_PORT: "3306"
