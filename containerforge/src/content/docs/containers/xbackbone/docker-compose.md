...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3de12b8228f4686affac7055021a8a46WORD
      MARIADB_ROOT_PASSWORD: 7f1afbd7a8f1150ba3eeee8ccbbd01c3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3de12b8228f4686affac7055021a8a46WORD
      DB_PORT: "3306"
