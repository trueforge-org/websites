...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6f83561e647e00bec93a82155913b03fWORD
      MARIADB_ROOT_PASSWORD: b5d0e307d34cbca304b6a8af67c401afWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6f83561e647e00bec93a82155913b03fWORD
      DB_PORT: "3306"
