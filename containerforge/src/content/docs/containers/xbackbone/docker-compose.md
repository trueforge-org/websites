...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0212e48adf04d58bccf4b72526c8caa7WORD
      MARIADB_ROOT_PASSWORD: 32ec3190e06d253bdacfd2bf2841ce8cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0212e48adf04d58bccf4b72526c8caa7WORD
      DB_PORT: "3306"
