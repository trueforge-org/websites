...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a05d0bf6100f355f3116e3eab1dc09a2WORD
      MARIADB_ROOT_PASSWORD: 3faebb75b57ebcc1e12be4bc95dedf52WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a05d0bf6100f355f3116e3eab1dc09a2WORD
      DB_PORT: "3306"
