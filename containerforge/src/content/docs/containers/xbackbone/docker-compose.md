...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b02ed5087b4345f30b33dc86e36a8a20WORD
      MARIADB_ROOT_PASSWORD: bea0fdb8061a05be59d36b8be2abb782WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b02ed5087b4345f30b33dc86e36a8a20WORD
      DB_PORT: "3306"
