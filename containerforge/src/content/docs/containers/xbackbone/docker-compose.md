...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a01db919392e2605a00a2711abdc5d09WORD
      MARIADB_ROOT_PASSWORD: fef0f0a5421add457ce6f7cb47004d5dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a01db919392e2605a00a2711abdc5d09WORD
      DB_PORT: "3306"
