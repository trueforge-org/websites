...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ecc50a6e093bb017dd85a0ca9f8fa0e7WORD
      MARIADB_ROOT_PASSWORD: 132f484e93054e5bc50c393bfc632995WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ecc50a6e093bb017dd85a0ca9f8fa0e7WORD
      DB_PORT: "3306"
