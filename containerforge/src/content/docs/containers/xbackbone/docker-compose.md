...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 019fad24ff972bf31227aab23c9e08f6WORD
      MARIADB_ROOT_PASSWORD: 4052748e1d7f363efe663ccba6b0d0a4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 019fad24ff972bf31227aab23c9e08f6WORD
      DB_PORT: "3306"
