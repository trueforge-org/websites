...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 40003231bc18318977198b08b73417e3WORD
      MARIADB_ROOT_PASSWORD: 3e758dfddc7d640a91ca7ed13a588ebfWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 40003231bc18318977198b08b73417e3WORD
      DB_PORT: "3306"
