...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8bcca16b7a613389b9272b6d142d8827WORD
      MARIADB_ROOT_PASSWORD: 6848976223e610cccbba8f48ef1b982aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8bcca16b7a613389b9272b6d142d8827WORD
      DB_PORT: "3306"
