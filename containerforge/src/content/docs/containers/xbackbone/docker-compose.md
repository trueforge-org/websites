...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e640da68d1e2be50e8046d4d06c5e856WORD
      MARIADB_ROOT_PASSWORD: 2dff5bec2e4ce97324f1bfc0edec4a08WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e640da68d1e2be50e8046d4d06c5e856WORD
      DB_PORT: "3306"
