...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 19f88faaa0f4627a8602d837fa7d9f58WORD
      MARIADB_ROOT_PASSWORD: 52ee68efe2c867acc2e3326fe90a8905WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 19f88faaa0f4627a8602d837fa7d9f58WORD
      DB_PORT: "3306"
