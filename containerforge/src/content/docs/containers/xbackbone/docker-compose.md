...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5910433cdd441a65a30a1fef8485a5cfWORD
      MARIADB_ROOT_PASSWORD: c5b00827e79aa8492c874eaf1fbd66e7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5910433cdd441a65a30a1fef8485a5cfWORD
      DB_PORT: "3306"
