...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fa919f3881819463f31ebd4871fc57cfWORD
      MARIADB_ROOT_PASSWORD: d609612d18194e0166c56631c3fdb34aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fa919f3881819463f31ebd4871fc57cfWORD
      DB_PORT: "3306"
