...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 317e233c485f714d9260484bea86b14dWORD
      MARIADB_ROOT_PASSWORD: 6dd22260b9f53688641d0a0511534ecaWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 317e233c485f714d9260484bea86b14dWORD
      DB_PORT: "3306"
