...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 651ff121472eb506980b5876e05a7eedWORD
      MARIADB_ROOT_PASSWORD: af9328d0cdf7af99744da7a161b957a9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 651ff121472eb506980b5876e05a7eedWORD
      DB_PORT: "3306"
