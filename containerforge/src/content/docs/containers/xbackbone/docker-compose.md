...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 316f2a289eb875ce6791393789a223ddWORD
      MARIADB_ROOT_PASSWORD: 18de11ffd74fab27e2390c52f7c8cb32WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 316f2a289eb875ce6791393789a223ddWORD
      DB_PORT: "3306"
