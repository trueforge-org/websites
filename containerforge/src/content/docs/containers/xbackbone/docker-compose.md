...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: daf9f2cd240e23a1e1301552bce2bd64WORD
      MARIADB_ROOT_PASSWORD: 3705cf66b4587aec5325bdf6632b1309WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: daf9f2cd240e23a1e1301552bce2bd64WORD
      DB_PORT: "3306"
