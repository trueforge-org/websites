...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3c4ad455ac30591ff4afeb648367508cWORD
      MARIADB_ROOT_PASSWORD: 7001531146fa55b69c11dab436cb42c5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3c4ad455ac30591ff4afeb648367508cWORD
      DB_PORT: "3306"
