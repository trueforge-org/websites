...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e7f6b2bb8956df7099360a2e868e5405WORD
      MARIADB_ROOT_PASSWORD: 7db0dbfd47c9e3103a609cf2003ee207WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e7f6b2bb8956df7099360a2e868e5405WORD
      DB_PORT: "3306"
