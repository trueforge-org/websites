...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 29029805896b60ec8d0552f139492555WORD
      MARIADB_ROOT_PASSWORD: 11aff5962cfec33017a394bd956a39b3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 29029805896b60ec8d0552f139492555WORD
      DB_PORT: "3306"
