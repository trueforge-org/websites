...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 01ca43e4a003fc8a4bd863b852e934a6WORD
      MARIADB_ROOT_PASSWORD: 2515d9abc39070b2d3f03a1e3524fc93WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 01ca43e4a003fc8a4bd863b852e934a6WORD
      DB_PORT: "3306"
