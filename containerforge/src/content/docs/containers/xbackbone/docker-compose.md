...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ceb72e50efdec4d143ea32d6e0d17c2fWORD
      MARIADB_ROOT_PASSWORD: fc8cd525d16f3b443233f5f100a97ed6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ceb72e50efdec4d143ea32d6e0d17c2fWORD
      DB_PORT: "3306"
