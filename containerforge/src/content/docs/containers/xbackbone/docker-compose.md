...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8e04e2242d810d2fb377231c0d723981WORD
      MARIADB_ROOT_PASSWORD: 37ec999ec25b6b1e3c5756d558683b83WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8e04e2242d810d2fb377231c0d723981WORD
      DB_PORT: "3306"
