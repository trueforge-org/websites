...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f92490dfbd5ede05ec60e5e66aa03675WORD
      MARIADB_ROOT_PASSWORD: e0bfe813fc220f4de2e6395a2192a969WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f92490dfbd5ede05ec60e5e66aa03675WORD
      DB_PORT: "3306"
