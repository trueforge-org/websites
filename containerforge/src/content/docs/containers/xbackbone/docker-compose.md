...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a81df508152e15fff0515a47efdcf893WORD
      MARIADB_ROOT_PASSWORD: 4a0a24a708529cc6d2e74914da19ebe9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a81df508152e15fff0515a47efdcf893WORD
      DB_PORT: "3306"
