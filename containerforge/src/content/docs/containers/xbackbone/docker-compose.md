...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8c0d701d730d03a8ff27d841bb21ff37WORD
      MARIADB_ROOT_PASSWORD: 781c0f0d771266718c2c6149beae8e62WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8c0d701d730d03a8ff27d841bb21ff37WORD
      DB_PORT: "3306"
