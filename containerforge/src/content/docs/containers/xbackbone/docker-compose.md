...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ca4584f39005f1fb159fdc3cd1d71bf3WORD
      MARIADB_ROOT_PASSWORD: e584549cdfbfa830853529c0d6601ff6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ca4584f39005f1fb159fdc3cd1d71bf3WORD
      DB_PORT: "3306"
