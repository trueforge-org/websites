...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1bb31f9d1a8865f65f3562f7b1815a14WORD
      MARIADB_ROOT_PASSWORD: 63da5043f83972872f7ff3ce2c7925edWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1bb31f9d1a8865f65f3562f7b1815a14WORD
      DB_PORT: "3306"
