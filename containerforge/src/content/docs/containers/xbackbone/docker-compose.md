...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b87b6b6c973dadeec4b42fb5f67b9735WORD
      MARIADB_ROOT_PASSWORD: ac7002fd2b9b2cdbc3b9be417e9b90d8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b87b6b6c973dadeec4b42fb5f67b9735WORD
      DB_PORT: "3306"
