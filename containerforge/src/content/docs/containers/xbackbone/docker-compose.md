...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8379705dcfbe3d24f302b9365fac9227WORD
      MARIADB_ROOT_PASSWORD: 3e2f4cda13c9845b4e3f12cef0f1fe04WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8379705dcfbe3d24f302b9365fac9227WORD
      DB_PORT: "3306"
