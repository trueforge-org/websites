...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 693913544fd7a692f244de426056c292WORD
      MARIADB_ROOT_PASSWORD: d9fab78de566810bde098f77ce9c7434WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 693913544fd7a692f244de426056c292WORD
      DB_PORT: "3306"
