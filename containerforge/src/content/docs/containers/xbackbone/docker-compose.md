...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e9c7e4eccf0815121c7c16c1d61cd0faWORD
      MARIADB_ROOT_PASSWORD: b4dda62791a4ec8f5e7525a4e7a0a993WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e9c7e4eccf0815121c7c16c1d61cd0faWORD
      DB_PORT: "3306"
