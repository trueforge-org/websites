...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dc7286656972272fcda2a72b53708a4cWORD
      MARIADB_ROOT_PASSWORD: df2265a5c1ff71f771436674eadadc0aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dc7286656972272fcda2a72b53708a4cWORD
      DB_PORT: "3306"
