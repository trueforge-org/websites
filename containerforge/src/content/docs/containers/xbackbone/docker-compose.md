...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 90d8dc2644bd2dde8b501ff7c42ad17dWORD
      MARIADB_ROOT_PASSWORD: 94dbe66aaea4534110b18755943d02d3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 90d8dc2644bd2dde8b501ff7c42ad17dWORD
      DB_PORT: "3306"
