...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e95cb56e562df63e3e31fbf2023a4b88WORD
      MARIADB_ROOT_PASSWORD: 2a55d60e8bab3deb7171107ae0327087WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e95cb56e562df63e3e31fbf2023a4b88WORD
      DB_PORT: "3306"
