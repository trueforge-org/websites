...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e74faacdd020b22ca84ecfb646b8314fWORD
      MARIADB_ROOT_PASSWORD: c3dc4c1b69cca64a40832aedf0baa95fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e74faacdd020b22ca84ecfb646b8314fWORD
      DB_PORT: "3306"
