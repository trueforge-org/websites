...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 397268da1ec6d4101d0173630a767f34WORD
      MARIADB_ROOT_PASSWORD: 23c0a08abf2eb4ffdb019610ce4b17c9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 397268da1ec6d4101d0173630a767f34WORD
      DB_PORT: "3306"
