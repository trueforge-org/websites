...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0ee49214968793028e99f3da3478b878WORD
      MARIADB_ROOT_PASSWORD: 80c53a3d51214ab311b0056b93dc10f6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0ee49214968793028e99f3da3478b878WORD
      DB_PORT: "3306"
