...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d1a7be1c3abaa73934a01d0d59f07a77WORD
      MARIADB_ROOT_PASSWORD: 9576d5a85334ce55f078bc51024514adWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d1a7be1c3abaa73934a01d0d59f07a77WORD
      DB_PORT: "3306"
