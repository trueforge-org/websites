...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 42ac16ff06eef3d514f13980c2cceeb0WORD
      MARIADB_ROOT_PASSWORD: 48b18f292f59ad3644e691ecdfe7cb4cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 42ac16ff06eef3d514f13980c2cceeb0WORD
      DB_PORT: "3306"
