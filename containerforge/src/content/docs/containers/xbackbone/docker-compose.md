...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9c49e5e01f56010c36b2684148bffa6aWORD
      MARIADB_ROOT_PASSWORD: 5609c5d0ba9e5909a70bd49f86a4b079WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9c49e5e01f56010c36b2684148bffa6aWORD
      DB_PORT: "3306"
