...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f6bc05c5792e573f1dfd1e1f4a0efcb1WORD
      MARIADB_ROOT_PASSWORD: d237c723e35fe387a6e402380adc1b15WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f6bc05c5792e573f1dfd1e1f4a0efcb1WORD
      DB_PORT: "3306"
