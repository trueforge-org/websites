...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5b0b5cdb7d5e8782b4e8196ceeebcd22WORD
      MARIADB_ROOT_PASSWORD: e8873436d8ea92a86f21c04475fb763cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5b0b5cdb7d5e8782b4e8196ceeebcd22WORD
      DB_PORT: "3306"
