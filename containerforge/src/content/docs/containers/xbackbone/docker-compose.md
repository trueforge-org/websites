...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ce4999838114065f7c35a6a1537773c5WORD
      MARIADB_ROOT_PASSWORD: 75dd569f036025984d9bf3254ded67deWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ce4999838114065f7c35a6a1537773c5WORD
      DB_PORT: "3306"
