...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d1650b0f01023de5997c568d0a345476WORD
      MARIADB_ROOT_PASSWORD: 279bab69009577207e744c0480cb45f5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d1650b0f01023de5997c568d0a345476WORD
      DB_PORT: "3306"
