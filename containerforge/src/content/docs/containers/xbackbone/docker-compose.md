...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e01d8a8dac7602fa27ae733c4c5fc91dWORD
      MARIADB_ROOT_PASSWORD: f821a2ea0e878c3b1a0fec543d5a5330WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e01d8a8dac7602fa27ae733c4c5fc91dWORD
      DB_PORT: "3306"
