...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bfb297919d503bb5ba65f266e00cde44WORD
      MARIADB_ROOT_PASSWORD: 5fb8af0707998c2b56faae5ee9a3485cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bfb297919d503bb5ba65f266e00cde44WORD
      DB_PORT: "3306"
