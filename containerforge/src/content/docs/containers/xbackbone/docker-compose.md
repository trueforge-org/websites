...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3eb40e0616e0b0750fcd64d4b9b8cd5aWORD
      MARIADB_ROOT_PASSWORD: ac379ccf6fcc7994f58db11b27735921WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3eb40e0616e0b0750fcd64d4b9b8cd5aWORD
      DB_PORT: "3306"
