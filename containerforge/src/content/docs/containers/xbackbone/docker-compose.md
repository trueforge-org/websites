...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d49b8e5234c3d378a55b8c1ea9852d16WORD
      MARIADB_ROOT_PASSWORD: a358511fbb5a9df5eb73cb4834aba3faWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d49b8e5234c3d378a55b8c1ea9852d16WORD
      DB_PORT: "3306"
