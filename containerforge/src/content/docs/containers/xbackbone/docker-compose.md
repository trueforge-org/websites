...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 50dfdc9b5b75290aaec76f6b324c7ab8WORD
      MARIADB_ROOT_PASSWORD: 238a29567432f5a2bf77b31b4c6d7749WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 50dfdc9b5b75290aaec76f6b324c7ab8WORD
      DB_PORT: "3306"
