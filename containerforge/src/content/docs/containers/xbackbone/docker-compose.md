...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dbd51000303656a61a74bbd245dead48WORD
      MARIADB_ROOT_PASSWORD: 793206d2e76348b5028f70350ede1667WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dbd51000303656a61a74bbd245dead48WORD
      DB_PORT: "3306"
