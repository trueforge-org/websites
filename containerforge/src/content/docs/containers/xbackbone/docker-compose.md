...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7308b325de7c65903337df6941692ce4WORD
      MARIADB_ROOT_PASSWORD: ee161dcc421b354d38acec91c2e24c09WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7308b325de7c65903337df6941692ce4WORD
      DB_PORT: "3306"
