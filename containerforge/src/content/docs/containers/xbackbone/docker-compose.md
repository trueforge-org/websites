...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 024e36b55019cb01f154b8391b9ef221WORD
      MARIADB_ROOT_PASSWORD: fcab3531b863161c7414d670613a7acbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 024e36b55019cb01f154b8391b9ef221WORD
      DB_PORT: "3306"
