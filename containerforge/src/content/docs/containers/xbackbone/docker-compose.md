...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 60b73db2e466e6e412e0d6aff62a4a95WORD
      MARIADB_ROOT_PASSWORD: 191845f0b1723abed6dab5ef9b37816cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 60b73db2e466e6e412e0d6aff62a4a95WORD
      DB_PORT: "3306"
