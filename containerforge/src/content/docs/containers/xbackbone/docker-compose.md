...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c415187954de389b04969854d4073903WORD
      MARIADB_ROOT_PASSWORD: ad6f0beef6a40bf9a3ff65b96629c49aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c415187954de389b04969854d4073903WORD
      DB_PORT: "3306"
