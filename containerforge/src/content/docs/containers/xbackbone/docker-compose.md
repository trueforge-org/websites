...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1b12be755769eba70f06f8bff882be45WORD
      MARIADB_ROOT_PASSWORD: 6c024e921a6f1143b756453c0bf8ba7eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1b12be755769eba70f06f8bff882be45WORD
      DB_PORT: "3306"
