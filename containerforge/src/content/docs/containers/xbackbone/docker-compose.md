...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4b46f33b1b383ee16a2917ad5ccdd16bWORD
      MARIADB_ROOT_PASSWORD: 2940f57c9ed308a9a45f2c7a5b591bf1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4b46f33b1b383ee16a2917ad5ccdd16bWORD
      DB_PORT: "3306"
