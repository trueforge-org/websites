...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 98d6285b992d2688d00a6a21d42e5e53WORD
      MARIADB_ROOT_PASSWORD: 613f8a0eafb5dc1c42085b885f30765fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 98d6285b992d2688d00a6a21d42e5e53WORD
      DB_PORT: "3306"
