...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 496b14e12786e50ad07e5a5b433d1b7cWORD
      MARIADB_ROOT_PASSWORD: cf8197592c2ef7012e0bf8e92fe54a2cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 496b14e12786e50ad07e5a5b433d1b7cWORD
      DB_PORT: "3306"
