...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 573bfd65eadcdeaeab6b1a4d47bcd917WORD
      MARIADB_ROOT_PASSWORD: 8a953d39f17c214b7fa9ed896502ee4cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 573bfd65eadcdeaeab6b1a4d47bcd917WORD
      DB_PORT: "3306"
