...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: badb77a07cb1227dc8cec0f415fbaff9WORD
      MARIADB_ROOT_PASSWORD: 545ea53f9635f87327f42488868ebd7aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: badb77a07cb1227dc8cec0f415fbaff9WORD
      DB_PORT: "3306"
