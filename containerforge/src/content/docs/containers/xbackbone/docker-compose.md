...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0ecd8ceb93536be7eda8cf170db369b8WORD
      MARIADB_ROOT_PASSWORD: 0c48ec364995bebd118cef9cad51009eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0ecd8ceb93536be7eda8cf170db369b8WORD
      DB_PORT: "3306"
