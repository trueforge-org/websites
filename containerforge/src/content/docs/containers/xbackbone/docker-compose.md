...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ada23d244ce6084ce925acd6be5ed566WORD
      MARIADB_ROOT_PASSWORD: 3de78686219be628a9d25cdd8a788fb2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ada23d244ce6084ce925acd6be5ed566WORD
      DB_PORT: "3306"
