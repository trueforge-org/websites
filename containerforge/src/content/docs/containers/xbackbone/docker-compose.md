...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5aaf9952f419cbd14a02a4f5afa2454aWORD
      MARIADB_ROOT_PASSWORD: afffd5a275ab8167dcfd0edcc08b2f88WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5aaf9952f419cbd14a02a4f5afa2454aWORD
      DB_PORT: "3306"
