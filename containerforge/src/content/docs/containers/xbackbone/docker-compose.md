...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e3cee438aa44da162e820f81c10299bcWORD
      MARIADB_ROOT_PASSWORD: d45b175d5114a36181e1c8864f4b16d4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e3cee438aa44da162e820f81c10299bcWORD
      DB_PORT: "3306"
