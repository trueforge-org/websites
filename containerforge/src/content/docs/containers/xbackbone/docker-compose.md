...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 36b13e414f9e73388f0efcab17c4423fWORD
      MARIADB_ROOT_PASSWORD: fca17e744f012617b2580513535b4f51WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 36b13e414f9e73388f0efcab17c4423fWORD
      DB_PORT: "3306"
