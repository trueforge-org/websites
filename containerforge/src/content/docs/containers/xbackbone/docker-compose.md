...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 48af83381b8ed700a8d7dc3b1d094e3dWORD
      MARIADB_ROOT_PASSWORD: 7104044c82b14d9748f12379a3201687WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 48af83381b8ed700a8d7dc3b1d094e3dWORD
      DB_PORT: "3306"
