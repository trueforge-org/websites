...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cac807a7f7192153906e4a5562a627c3WORD
      MARIADB_ROOT_PASSWORD: b70e7233d859889f2609938d45dc851eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cac807a7f7192153906e4a5562a627c3WORD
      DB_PORT: "3306"
