...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 88dcc6342adab7c46cdfea62d044a589WORD
      MARIADB_ROOT_PASSWORD: 8b663cfafd745baf3377ebf94a485c18WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 88dcc6342adab7c46cdfea62d044a589WORD
      DB_PORT: "3306"
