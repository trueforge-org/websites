...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 45fe5a6fda5f913abe1fd31a700cd490WORD
      MARIADB_ROOT_PASSWORD: 6dadbf9ed98b68404f5d0d3e3eb0243eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 45fe5a6fda5f913abe1fd31a700cd490WORD
      DB_PORT: "3306"
