...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0365de0ce747934b081c55459fc118acWORD
      MARIADB_ROOT_PASSWORD: 0fd2178db8ae010b2183a00fbcd92da0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0365de0ce747934b081c55459fc118acWORD
      DB_PORT: "3306"
