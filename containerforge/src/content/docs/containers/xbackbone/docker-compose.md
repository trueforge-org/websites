...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c8443f3e320d785dfd2d1efd8cae9a43WORD
      MARIADB_ROOT_PASSWORD: bece6998ed14e3187f6e151ba82c2e0eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c8443f3e320d785dfd2d1efd8cae9a43WORD
      DB_PORT: "3306"
