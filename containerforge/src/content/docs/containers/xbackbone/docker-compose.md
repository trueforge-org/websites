...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f763dbe8f0501da0762a6e8d95591d89WORD
      MARIADB_ROOT_PASSWORD: 221580b736e964e4384cc66042d718c5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f763dbe8f0501da0762a6e8d95591d89WORD
      DB_PORT: "3306"
