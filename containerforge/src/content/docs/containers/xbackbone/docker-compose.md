...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: eef0a2b3cbed828fa067d42847087b2eWORD
      MARIADB_ROOT_PASSWORD: b8431a07a1ac89fb62cd25c0fdd27416WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: eef0a2b3cbed828fa067d42847087b2eWORD
      DB_PORT: "3306"
