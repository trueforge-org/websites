...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 50c24f3699ac95b459865ac2d1e3b3ebWORD
      MARIADB_ROOT_PASSWORD: 8afd682f1f0a10ca351f15f93a18394cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 50c24f3699ac95b459865ac2d1e3b3ebWORD
      DB_PORT: "3306"
