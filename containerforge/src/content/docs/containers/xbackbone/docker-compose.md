...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7ad8a4bcee56bf7dd0d4697b64d27638WORD
      MARIADB_ROOT_PASSWORD: e752f7536690c328f95ac622de47ef5eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7ad8a4bcee56bf7dd0d4697b64d27638WORD
      DB_PORT: "3306"
