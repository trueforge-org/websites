...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4d800f95467ab89b4fb764ceffb6c214WORD
      MARIADB_ROOT_PASSWORD: ebbc325f718786563dc8e673c9e7d436WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4d800f95467ab89b4fb764ceffb6c214WORD
      DB_PORT: "3306"
