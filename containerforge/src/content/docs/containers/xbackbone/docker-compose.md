...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 78fdf51e7861f8f9738bac00a4865f83WORD
      MARIADB_ROOT_PASSWORD: 4f616f02daec072339ea19ae8c6e1c20WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 78fdf51e7861f8f9738bac00a4865f83WORD
      DB_PORT: "3306"
