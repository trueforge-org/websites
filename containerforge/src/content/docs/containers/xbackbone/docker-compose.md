...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5f40dad3364e130538c7c92fcbbd6d32WORD
      MARIADB_ROOT_PASSWORD: 3b30b1d6f9978886665cd3207008d539WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5f40dad3364e130538c7c92fcbbd6d32WORD
      DB_PORT: "3306"
