...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6c381cb68ceb76c2d4e4b3a62aea822cWORD
      MARIADB_ROOT_PASSWORD: 1d47abc3e1ac61668f5d0e478a58be37WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6c381cb68ceb76c2d4e4b3a62aea822cWORD
      DB_PORT: "3306"
