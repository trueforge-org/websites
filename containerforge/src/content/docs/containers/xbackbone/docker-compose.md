...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 16fa9596f11e4717c5983ce32bcf4c6fWORD
      MARIADB_ROOT_PASSWORD: 0fe072c90008cd6fa5409e551b1fec13WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 16fa9596f11e4717c5983ce32bcf4c6fWORD
      DB_PORT: "3306"
