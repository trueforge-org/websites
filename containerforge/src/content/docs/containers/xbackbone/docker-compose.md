...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dd36ee6a442170fac7529cde65ab7875WORD
      MARIADB_ROOT_PASSWORD: 844d7e070560ca2ba100ca3714bf1d8eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dd36ee6a442170fac7529cde65ab7875WORD
      DB_PORT: "3306"
