...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8a78acf5e20ab45038dd76503c9c1e07WORD
      MARIADB_ROOT_PASSWORD: 01aea0d5953118b6829084851587d1c5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8a78acf5e20ab45038dd76503c9c1e07WORD
      DB_PORT: "3306"
