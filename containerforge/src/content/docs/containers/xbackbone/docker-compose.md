...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 79fbb828b256a7d9629893f815138d96WORD
      MARIADB_ROOT_PASSWORD: e9ee44448b28dbe979f02e48eeda24feWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 79fbb828b256a7d9629893f815138d96WORD
      DB_PORT: "3306"
