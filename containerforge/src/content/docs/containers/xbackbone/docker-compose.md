...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d8feba27de286cab35c9ec0c4ffcb015WORD
      MARIADB_ROOT_PASSWORD: 6a64b18bd5a2a15abced6e02dc361817WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d8feba27de286cab35c9ec0c4ffcb015WORD
      DB_PORT: "3306"
