...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a3ce956e40745a1dad4451e54968de59WORD
      MARIADB_ROOT_PASSWORD: e3af085ea93c34f0f05141d9a2e5a7d5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a3ce956e40745a1dad4451e54968de59WORD
      DB_PORT: "3306"
