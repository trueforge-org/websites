...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c1c514c165cdbe9856e0d89780f62974WORD
      MARIADB_ROOT_PASSWORD: 2566b6b768cabe9b918e25d72ac5794bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c1c514c165cdbe9856e0d89780f62974WORD
      DB_PORT: "3306"
