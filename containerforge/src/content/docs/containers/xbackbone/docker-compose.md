...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0e7bc06e87aa71dfdfd5b6cdaa00a541WORD
      MARIADB_ROOT_PASSWORD: 371907609b3982c320c810e388d0fa37WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0e7bc06e87aa71dfdfd5b6cdaa00a541WORD
      DB_PORT: "3306"
