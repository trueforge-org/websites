...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4c5372823a183a250db20bdd35b05d3cWORD
      MARIADB_ROOT_PASSWORD: a1d34b5e69869b89479de843ac54eee6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4c5372823a183a250db20bdd35b05d3cWORD
      DB_PORT: "3306"
