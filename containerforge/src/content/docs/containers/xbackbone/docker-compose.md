...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6ba07dbd6c9c9a1b90868700478359cfWORD
      MARIADB_ROOT_PASSWORD: 46d1f1863f97cbd8463a6706be0686c2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6ba07dbd6c9c9a1b90868700478359cfWORD
      DB_PORT: "3306"
