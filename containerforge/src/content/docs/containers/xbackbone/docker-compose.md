...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: eebfb1d1d35d54263a3992a9756daa36WORD
      MARIADB_ROOT_PASSWORD: 78efc75de63f81b92a31bba662c056ebWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: eebfb1d1d35d54263a3992a9756daa36WORD
      DB_PORT: "3306"
