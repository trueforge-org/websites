...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 96b4033e2e392669a953b86b9d88f3e7WORD
      MARIADB_ROOT_PASSWORD: 37064da70602ec06c57a2ba99d89e0f8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 96b4033e2e392669a953b86b9d88f3e7WORD
      DB_PORT: "3306"
