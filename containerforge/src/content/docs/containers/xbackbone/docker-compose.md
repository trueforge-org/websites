...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6db7a65be311c0f2dbc7183010523dd7WORD
      MARIADB_ROOT_PASSWORD: 85955ac29e825834d83fe8c01af75248WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6db7a65be311c0f2dbc7183010523dd7WORD
      DB_PORT: "3306"
