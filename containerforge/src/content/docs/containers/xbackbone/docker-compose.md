...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 35cb8fb8f95cd8e851a0aa45985e92a0WORD
      MARIADB_ROOT_PASSWORD: 6a3363358097b7ee956a0be0e8713691WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 35cb8fb8f95cd8e851a0aa45985e92a0WORD
      DB_PORT: "3306"
