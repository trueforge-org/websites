...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fd117fb9f763d4da879b1c832ec420f9WORD
      MARIADB_ROOT_PASSWORD: 3577950a77acf33d077a9603f9a18666WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fd117fb9f763d4da879b1c832ec420f9WORD
      DB_PORT: "3306"
