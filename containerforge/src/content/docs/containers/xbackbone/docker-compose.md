...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f00fa95112f7d747137eae85d7b475ecWORD
      MARIADB_ROOT_PASSWORD: 33aeccfbd8560f6cd05d5a4871dd570bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f00fa95112f7d747137eae85d7b475ecWORD
      DB_PORT: "3306"
