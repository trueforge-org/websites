...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 40d1d414ddd007e6aac6a82e2d3f1e96WORD
      MARIADB_ROOT_PASSWORD: b512afa4a28498ee3c0319c7ebecf2a5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 40d1d414ddd007e6aac6a82e2d3f1e96WORD
      DB_PORT: "3306"
