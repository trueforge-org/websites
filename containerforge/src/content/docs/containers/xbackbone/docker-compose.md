...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3b64dd3fb6ec5b521709539aaba1459eWORD
      MARIADB_ROOT_PASSWORD: 0b5c974e7fa3f627a4b4107afa03ca44WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3b64dd3fb6ec5b521709539aaba1459eWORD
      DB_PORT: "3306"
