...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4267b178ce59ffdfc9fa4159c0c68907WORD
      MARIADB_ROOT_PASSWORD: e35d46402bb13c745dc90370088a2d7fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4267b178ce59ffdfc9fa4159c0c68907WORD
      DB_PORT: "3306"
