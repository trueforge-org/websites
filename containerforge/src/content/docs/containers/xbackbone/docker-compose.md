...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a81c7bb4ff19f082e61519b4416594dfWORD
      MARIADB_ROOT_PASSWORD: f432e4aa038c8df7237df3af53db0bc6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a81c7bb4ff19f082e61519b4416594dfWORD
      DB_PORT: "3306"
