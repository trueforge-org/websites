...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0905faf9cda27f32c5e73efd5a992f16WORD
      MARIADB_ROOT_PASSWORD: 8a03efb6c2233247dd2f112a007862b1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0905faf9cda27f32c5e73efd5a992f16WORD
      DB_PORT: "3306"
