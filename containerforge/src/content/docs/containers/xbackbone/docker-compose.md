...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b4b0fff09829eca414c161197b2681a5WORD
      MARIADB_ROOT_PASSWORD: 273872f72e083e4c17f061bdf96bae11WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b4b0fff09829eca414c161197b2681a5WORD
      DB_PORT: "3306"
