...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9012a067d109a2dfb41f376d65a28c84WORD
      MARIADB_ROOT_PASSWORD: e298120faafe55f1ad53692baa3b969aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9012a067d109a2dfb41f376d65a28c84WORD
      DB_PORT: "3306"
