...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bb0deca3d834e78d7fa6aab1c4dc9ee4WORD
      MARIADB_ROOT_PASSWORD: 8ef3eb98250aaf4bb01ca382187152dbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bb0deca3d834e78d7fa6aab1c4dc9ee4WORD
      DB_PORT: "3306"
