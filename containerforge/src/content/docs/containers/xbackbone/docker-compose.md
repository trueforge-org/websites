...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0d67a9f2648d0eb9edc916cd924023e7WORD
      MARIADB_ROOT_PASSWORD: 3966c0450ae4a6c6e2df72e126e536c0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0d67a9f2648d0eb9edc916cd924023e7WORD
      DB_PORT: "3306"
