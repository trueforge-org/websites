...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c1a981840b523235a8a8cfc03187ee7dWORD
      MARIADB_ROOT_PASSWORD: e14a901233e7227f4cef046ac1c843a7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c1a981840b523235a8a8cfc03187ee7dWORD
      DB_PORT: "3306"
