...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 52d5fff2220bc806a651f885c1c43156WORD
      MARIADB_ROOT_PASSWORD: 47bb303855397f7678ed419ae2afbb97WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 52d5fff2220bc806a651f885c1c43156WORD
      DB_PORT: "3306"
