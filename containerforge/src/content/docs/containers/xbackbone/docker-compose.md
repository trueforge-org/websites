...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3fe4cf8da8f41682f024fee5bf6e7776WORD
      MARIADB_ROOT_PASSWORD: f8c9061fc8eac389ff9e207278a3e968WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3fe4cf8da8f41682f024fee5bf6e7776WORD
      DB_PORT: "3306"
