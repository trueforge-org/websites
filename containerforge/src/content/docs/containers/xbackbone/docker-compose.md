...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 848e43fdea93c8faee095ddfe57941b3WORD
      MARIADB_ROOT_PASSWORD: 2a3c595867648b2ed432f09778f91f91WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 848e43fdea93c8faee095ddfe57941b3WORD
      DB_PORT: "3306"
