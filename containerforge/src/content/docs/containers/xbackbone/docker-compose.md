...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 677a36ede3ec12e04d6b35e4eecab54cWORD
      MARIADB_ROOT_PASSWORD: 802e4b31fd6310800581460ed8976ce0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 677a36ede3ec12e04d6b35e4eecab54cWORD
      DB_PORT: "3306"
