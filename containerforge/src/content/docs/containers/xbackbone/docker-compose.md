...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f7c878c3e6056af65159ff776d7df0ecWORD
      MARIADB_ROOT_PASSWORD: 5a4fac4520a1117c7c82641243519084WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f7c878c3e6056af65159ff776d7df0ecWORD
      DB_PORT: "3306"
