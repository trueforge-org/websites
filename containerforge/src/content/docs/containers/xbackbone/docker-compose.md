...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f20cd716ddcc41da7df424f7266a284dWORD
      MARIADB_ROOT_PASSWORD: c2c6bb781772082270a1387e68d5e2efWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f20cd716ddcc41da7df424f7266a284dWORD
      DB_PORT: "3306"
