...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 00d49f577867e288ed1390e828a77bdcWORD
      MARIADB_ROOT_PASSWORD: e8b4a828c0e2d08dd9f1bba72cde2bddWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 00d49f577867e288ed1390e828a77bdcWORD
      DB_PORT: "3306"
