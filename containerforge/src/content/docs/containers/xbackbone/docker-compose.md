...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e6098a42495b1e5ef630e1eca54e4c9bWORD
      MARIADB_ROOT_PASSWORD: 05420404d19be825a6fd1d291c4b5fd3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e6098a42495b1e5ef630e1eca54e4c9bWORD
      DB_PORT: "3306"
