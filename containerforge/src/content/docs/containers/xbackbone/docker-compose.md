...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5e96ccb51c70854472d120071861f5f7WORD
      MARIADB_ROOT_PASSWORD: 13e50cd4d959ffb31b5d7b7ef32f6465WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5e96ccb51c70854472d120071861f5f7WORD
      DB_PORT: "3306"
