...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a855e02168813a8b847a9aa356c1b435WORD
      MARIADB_ROOT_PASSWORD: 5adaf93c8420652d32f1a263118cabc9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a855e02168813a8b847a9aa356c1b435WORD
      DB_PORT: "3306"
