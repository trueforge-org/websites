...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f30c9f3f51e7cf574ae97c6f0214a200WORD
      MARIADB_ROOT_PASSWORD: a4a489c4999ee015141a2ab8989f8634WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f30c9f3f51e7cf574ae97c6f0214a200WORD
      DB_PORT: "3306"
