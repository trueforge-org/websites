...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c594f6da2c50ba403188247150254b55WORD
      MARIADB_ROOT_PASSWORD: 28db1a90aca4914de8f403bd0a2a4603WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c594f6da2c50ba403188247150254b55WORD
      DB_PORT: "3306"
