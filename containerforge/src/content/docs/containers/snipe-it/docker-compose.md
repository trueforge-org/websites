...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2b265e3b44b7fc807791248621528bfeWORD
      MARIADB_ROOT_PASSWORD: 8eec442158e5a6376928997a21c0a989WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2b265e3b44b7fc807791248621528bfeWORD
      DB_PORT: "3306"
