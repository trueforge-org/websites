...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a0385da35ea78f1d9a8572ad2c371a1cWORD
      MARIADB_ROOT_PASSWORD: 930ede34a88635ddb69caf2a9c0e2d36WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a0385da35ea78f1d9a8572ad2c371a1cWORD
      DB_PORT: "3306"
