...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e4eac9dac94fb9ba9583dfe68420d38bWORD
      MARIADB_ROOT_PASSWORD: e6e6406c9d63950693f3f932680ccc27WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e4eac9dac94fb9ba9583dfe68420d38bWORD
      DB_PORT: "3306"
