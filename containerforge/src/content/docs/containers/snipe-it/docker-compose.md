...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1665a746232dd45130b9abd1c51a96b8WORD
      MARIADB_ROOT_PASSWORD: 9bf108002c792239a2a319163d617bddWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1665a746232dd45130b9abd1c51a96b8WORD
      DB_PORT: "3306"
