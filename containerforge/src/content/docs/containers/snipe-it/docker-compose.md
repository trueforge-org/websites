...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bc3897356537bc449cc64dfffbaa448cWORD
      MARIADB_ROOT_PASSWORD: a5bc663746b845f06b282e8332e2ebc4WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bc3897356537bc449cc64dfffbaa448cWORD
      DB_PORT: "3306"
