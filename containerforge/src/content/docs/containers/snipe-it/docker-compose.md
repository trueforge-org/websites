...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a1fcbd53f77dc173a2f62f286a5a3de8WORD
      MARIADB_ROOT_PASSWORD: 9653759da4ac0fcd33c70105aea9dc3dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a1fcbd53f77dc173a2f62f286a5a3de8WORD
      DB_PORT: "3306"
