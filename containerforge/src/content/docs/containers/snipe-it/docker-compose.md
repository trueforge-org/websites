...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 237bd0945ccadc160212ae05a7512cf6WORD
      MARIADB_ROOT_PASSWORD: c83356ae765c21d39a88b2b96aa25195WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 237bd0945ccadc160212ae05a7512cf6WORD
      DB_PORT: "3306"
