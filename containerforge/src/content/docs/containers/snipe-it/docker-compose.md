...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ddd92a5b176b3d0b745c6807a5eefc4bWORD
      MARIADB_ROOT_PASSWORD: 1d2397da066ec564e8eae454cf83fc39WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ddd92a5b176b3d0b745c6807a5eefc4bWORD
      DB_PORT: "3306"
