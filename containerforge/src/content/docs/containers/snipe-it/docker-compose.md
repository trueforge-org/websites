...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bc14d68908791baccbe655e9ab047f8fWORD
      MARIADB_ROOT_PASSWORD: e9c1881cb4cf0f61c4eab4b19740e829WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bc14d68908791baccbe655e9ab047f8fWORD
      DB_PORT: "3306"
