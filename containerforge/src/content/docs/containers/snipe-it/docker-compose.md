...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7159d045630c0bd64a761986081a3404WORD
      MARIADB_ROOT_PASSWORD: 0e5f249ba3ba84f00f68bea18f752a6cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7159d045630c0bd64a761986081a3404WORD
      DB_PORT: "3306"
