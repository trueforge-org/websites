...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 687ac27bdab4524b5921a052659cd036WORD
      MARIADB_ROOT_PASSWORD: 1aa8cabb6e9a76cd73db9a4829b12a9cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 687ac27bdab4524b5921a052659cd036WORD
      DB_PORT: "3306"
