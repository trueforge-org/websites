...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 562e483f62893211da52e6e00a8a49b6WORD
      MARIADB_ROOT_PASSWORD: 68366e4830c10a337e688a22aab4ebb0WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 562e483f62893211da52e6e00a8a49b6WORD
      DB_PORT: "3306"
