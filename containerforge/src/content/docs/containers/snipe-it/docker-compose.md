...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bac5b9620f196469786ec04248a6b699WORD
      MARIADB_ROOT_PASSWORD: b423cd4897a03b97ec8be806033a1f87WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bac5b9620f196469786ec04248a6b699WORD
      DB_PORT: "3306"
