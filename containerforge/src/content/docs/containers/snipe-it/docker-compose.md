...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 64b8797b3c662f788a64833680f4041cWORD
      MARIADB_ROOT_PASSWORD: 97bbf525252331d3d8ef1b86437d1e15WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 64b8797b3c662f788a64833680f4041cWORD
      DB_PORT: "3306"
