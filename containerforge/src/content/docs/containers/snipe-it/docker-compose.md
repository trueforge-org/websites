...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 90bae8db294c6e9b16efc1cf73f51246WORD
      MARIADB_ROOT_PASSWORD: 7d20569c190966e5d7a99328536ee6efWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 90bae8db294c6e9b16efc1cf73f51246WORD
      DB_PORT: "3306"
