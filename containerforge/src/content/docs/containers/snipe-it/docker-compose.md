...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6f3beb4bfdd93152d1cefe89398a0ab6WORD
      MARIADB_ROOT_PASSWORD: 5e4924a5e41d2f13b83e304f554aa331WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6f3beb4bfdd93152d1cefe89398a0ab6WORD
      DB_PORT: "3306"
