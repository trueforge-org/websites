...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9b8c17d67071734bd2157b663aa26b25WORD
      MARIADB_ROOT_PASSWORD: e07b99f94f7e66aa2951ee94fa2e0992WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9b8c17d67071734bd2157b663aa26b25WORD
      DB_PORT: "3306"
