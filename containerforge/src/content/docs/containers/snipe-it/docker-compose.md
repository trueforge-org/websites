...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 98dc9e0b2b902d6ec3f8628eab785f2bWORD
      MARIADB_ROOT_PASSWORD: 8e76ac008dcca8cbc739065cbff4caddWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 98dc9e0b2b902d6ec3f8628eab785f2bWORD
      DB_PORT: "3306"
