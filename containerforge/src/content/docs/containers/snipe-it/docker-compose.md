...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 424eb7988653cf8a572da573397fe62cWORD
      MARIADB_ROOT_PASSWORD: 2ad674991203d61eecab273c3d7d8704WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 424eb7988653cf8a572da573397fe62cWORD
      DB_PORT: "3306"
