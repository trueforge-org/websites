...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6d0cd34193dfd27ca6d1520d6ceb8077WORD
      MARIADB_ROOT_PASSWORD: ef0acf28012986ed43a1c2e5b9a8c1b6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6d0cd34193dfd27ca6d1520d6ceb8077WORD
      DB_PORT: "3306"
