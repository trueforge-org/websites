...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 63dc945c4243637a0823b24b2471497cWORD
      MARIADB_ROOT_PASSWORD: 7c727c86f956cf620a99568344fce054WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 63dc945c4243637a0823b24b2471497cWORD
      DB_PORT: "3306"
