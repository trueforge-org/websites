...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 668e2e53e707045d0ada617250230fa1WORD
      MARIADB_ROOT_PASSWORD: 849b003953d10e65935db90f399e5c29WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 668e2e53e707045d0ada617250230fa1WORD
      DB_PORT: "3306"
