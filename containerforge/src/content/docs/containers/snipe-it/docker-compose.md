...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5b5d8a1e4c0d73892885d8fd94543edeWORD
      MARIADB_ROOT_PASSWORD: 94d42ba0704bb72a2f63b8bc4591e79aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5b5d8a1e4c0d73892885d8fd94543edeWORD
      DB_PORT: "3306"
