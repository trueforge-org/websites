...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d200106182e96beecf32823c06da12b3WORD
      MARIADB_ROOT_PASSWORD: fb659a6f2c0b1ccc550d9e02b4fb7bc5WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d200106182e96beecf32823c06da12b3WORD
      DB_PORT: "3306"
