...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 90cb606fd77e0255f553f13c95a97f8bWORD
      MARIADB_ROOT_PASSWORD: f31d99c97355871e10976b9ff66bfccfWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 90cb606fd77e0255f553f13c95a97f8bWORD
      DB_PORT: "3306"
