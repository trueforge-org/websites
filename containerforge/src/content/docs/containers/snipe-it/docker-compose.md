...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c36c0de813955327a1dea550d8d67032WORD
      MARIADB_ROOT_PASSWORD: 506f858404c206119ef7c7c0abf6b573WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c36c0de813955327a1dea550d8d67032WORD
      DB_PORT: "3306"
