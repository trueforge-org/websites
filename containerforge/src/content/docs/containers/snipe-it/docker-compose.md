...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fe5a3999f4b83f5338dcfdf029524ae6WORD
      MARIADB_ROOT_PASSWORD: bee42ffa2a88f9d07dd09fab0ebd94fbWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fe5a3999f4b83f5338dcfdf029524ae6WORD
      DB_PORT: "3306"
