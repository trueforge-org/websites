...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7396a6494a3cfa0f7a6800c9039a4e8eWORD
      MARIADB_ROOT_PASSWORD: 1d201e6cb92b09d2ae06774f4fb7e029WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7396a6494a3cfa0f7a6800c9039a4e8eWORD
      DB_PORT: "3306"
