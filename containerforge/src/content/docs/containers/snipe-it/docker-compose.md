...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ed4d6e9e969c7b3995354bc8721da493WORD
      MARIADB_ROOT_PASSWORD: b82202eebf64dbfd695f24f5f81686aeWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ed4d6e9e969c7b3995354bc8721da493WORD
      DB_PORT: "3306"
