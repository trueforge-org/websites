...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b51141b7bb0afee38cdbf087ed067ba1WORD
      MARIADB_ROOT_PASSWORD: 2ca3a1cad0a69984d616fe9a0e40c342WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b51141b7bb0afee38cdbf087ed067ba1WORD
      DB_PORT: "3306"
