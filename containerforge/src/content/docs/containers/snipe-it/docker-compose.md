...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: abde270c11f57f986468798ac7f6a964WORD
      MARIADB_ROOT_PASSWORD: 6c3b67799c2ae70cdf5e5bcdea244890WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: abde270c11f57f986468798ac7f6a964WORD
      DB_PORT: "3306"
