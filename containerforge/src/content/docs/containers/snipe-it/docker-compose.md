...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6a719159de7ef573727fd613dcac5bbdWORD
      MARIADB_ROOT_PASSWORD: a4b45752f27b721d6f6d8b9163dd5818WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6a719159de7ef573727fd613dcac5bbdWORD
      DB_PORT: "3306"
