...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e1d2ad862fccf7ca2f17d5f577a3b985WORD
      MARIADB_ROOT_PASSWORD: b79292ed4fa59feaeeabd0cc7c666e0bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e1d2ad862fccf7ca2f17d5f577a3b985WORD
      DB_PORT: "3306"
