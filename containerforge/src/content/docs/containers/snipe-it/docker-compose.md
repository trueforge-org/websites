...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f173662ed8e7d048f7bf81cf999e78c5WORD
      MARIADB_ROOT_PASSWORD: 3ba1c538c893ccdf779a8d95f428367aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f173662ed8e7d048f7bf81cf999e78c5WORD
      DB_PORT: "3306"
