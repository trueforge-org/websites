...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2bcf603c951ddd8caf4e6f68813e6847WORD
      MARIADB_ROOT_PASSWORD: f834ca236eedf648aab2d59ac0a2dd4dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2bcf603c951ddd8caf4e6f68813e6847WORD
      DB_PORT: "3306"
