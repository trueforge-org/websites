...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 820fafc4d76a268da642c512e1567185WORD
      MARIADB_ROOT_PASSWORD: b458d1259734d7934de193e1a34485b9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 820fafc4d76a268da642c512e1567185WORD
      DB_PORT: "3306"
