...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d5f3a0c831f1561c376d4e9a645c0800WORD
      MARIADB_ROOT_PASSWORD: e48caa61d1f16fa99348b929b9fd969cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d5f3a0c831f1561c376d4e9a645c0800WORD
      DB_PORT: "3306"
