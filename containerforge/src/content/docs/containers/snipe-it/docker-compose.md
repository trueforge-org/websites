...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 317b4acb93b3a3f8d7951cbc682203c9WORD
      MARIADB_ROOT_PASSWORD: 3bf63ed019d201434ede10640b373a53WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 317b4acb93b3a3f8d7951cbc682203c9WORD
      DB_PORT: "3306"
