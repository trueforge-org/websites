...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 75d2cba0af0663899c10b88c11f9a34fWORD
      MARIADB_ROOT_PASSWORD: 48bbe1ef7716e6cc4a9233b30ee87309WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 75d2cba0af0663899c10b88c11f9a34fWORD
      DB_PORT: "3306"
