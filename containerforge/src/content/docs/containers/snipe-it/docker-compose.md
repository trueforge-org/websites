...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 52ec3146c824c9eda9098fe53465b6a8WORD
      MARIADB_ROOT_PASSWORD: cbb281b52b8cf9c09732db4abb1b88faWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 52ec3146c824c9eda9098fe53465b6a8WORD
      DB_PORT: "3306"
