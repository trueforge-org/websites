...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d30b36dd25c43629ae36c79d5221b620WORD
      MARIADB_ROOT_PASSWORD: 766eec2490d8de9fb53cd44126a4ad98WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d30b36dd25c43629ae36c79d5221b620WORD
      DB_PORT: "3306"
