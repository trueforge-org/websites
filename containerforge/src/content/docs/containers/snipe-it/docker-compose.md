...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fe375bbc1869c997fc33936cb1c95f98WORD
      MARIADB_ROOT_PASSWORD: d9b4d4d333ee22d2f05b88f38c8677efWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fe375bbc1869c997fc33936cb1c95f98WORD
      DB_PORT: "3306"
