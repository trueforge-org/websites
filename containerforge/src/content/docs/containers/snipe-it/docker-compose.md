...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ce4ea889f357ebb999a049688204de72WORD
      MARIADB_ROOT_PASSWORD: 00c70b5aa8d4fe238edd37f22671ee74WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ce4ea889f357ebb999a049688204de72WORD
      DB_PORT: "3306"
