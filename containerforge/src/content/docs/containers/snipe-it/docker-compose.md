...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4b83238d39060c33998103c7c62879bfWORD
      MARIADB_ROOT_PASSWORD: 223a46e646236d395e3e40bd382ed9a1WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4b83238d39060c33998103c7c62879bfWORD
      DB_PORT: "3306"
