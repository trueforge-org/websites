...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e74588f7871797ccee8e34436cda6b33WORD
      MARIADB_ROOT_PASSWORD: a8355ccfa05b4a9e9781fd457153fb5dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e74588f7871797ccee8e34436cda6b33WORD
      DB_PORT: "3306"
