...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 047fb62fbe6a7f187fc33c6c6b9f439fWORD
      MARIADB_ROOT_PASSWORD: bc7eddb3fad657e0f8556bc569916900WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 047fb62fbe6a7f187fc33c6c6b9f439fWORD
      DB_PORT: "3306"
