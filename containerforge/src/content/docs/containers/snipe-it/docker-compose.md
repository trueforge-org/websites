...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1602fb5c67452d97015f0de2c82a6752WORD
      MARIADB_ROOT_PASSWORD: f9964bc8f722bd320981962ddeefabb6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1602fb5c67452d97015f0de2c82a6752WORD
      DB_PORT: "3306"
