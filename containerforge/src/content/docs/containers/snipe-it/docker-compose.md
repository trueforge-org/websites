...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 341d1d2fd979c3dee5fc15f2831eeb3bWORD
      MARIADB_ROOT_PASSWORD: 2d5ef2d6ef080aa6a920cee533b85c4cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 341d1d2fd979c3dee5fc15f2831eeb3bWORD
      DB_PORT: "3306"
