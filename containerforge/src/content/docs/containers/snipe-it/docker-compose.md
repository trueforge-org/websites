...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 184820b063fdc6aed3b5b66b27107a0bWORD
      MARIADB_ROOT_PASSWORD: 4a98d80e809eb7525d2863d043b30a23WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 184820b063fdc6aed3b5b66b27107a0bWORD
      DB_PORT: "3306"
