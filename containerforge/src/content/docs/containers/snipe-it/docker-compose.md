...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7469d4883e0d2528b977871058b930fcWORD
      MARIADB_ROOT_PASSWORD: 926a20625f19622a0eb6acce2e6dea6dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7469d4883e0d2528b977871058b930fcWORD
      DB_PORT: "3306"
