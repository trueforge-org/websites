...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2b0c2bf42e16b4c265bf73f643861552WORD
      MARIADB_ROOT_PASSWORD: fa0d37c77a9b084488dda17b90b7bc3dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2b0c2bf42e16b4c265bf73f643861552WORD
      DB_PORT: "3306"
