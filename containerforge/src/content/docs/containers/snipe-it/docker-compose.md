...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1bcaef9c96a0cf2742a318b26db27af3WORD
      MARIADB_ROOT_PASSWORD: eb41f33cb0789de51e7b83f29803a208WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1bcaef9c96a0cf2742a318b26db27af3WORD
      DB_PORT: "3306"
