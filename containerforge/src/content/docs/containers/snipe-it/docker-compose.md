...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 875dcec2a3d2af55f4a2c5909f12ec2dWORD
      MARIADB_ROOT_PASSWORD: 154044cd7f4404bacbaf961e28632697WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 875dcec2a3d2af55f4a2c5909f12ec2dWORD
      DB_PORT: "3306"
