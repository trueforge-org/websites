...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4aabf9d11b2ecd7e65a793250d6c9af2WORD
      MARIADB_ROOT_PASSWORD: e814ebf9c0a3e155dd3845ebb94758baWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4aabf9d11b2ecd7e65a793250d6c9af2WORD
      DB_PORT: "3306"
