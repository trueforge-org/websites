...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ada79cfdf6a315a2b9a28e24cbc355a1WORD
      MARIADB_ROOT_PASSWORD: 8da1725da907325941264d7c552ba4d1WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ada79cfdf6a315a2b9a28e24cbc355a1WORD
      DB_PORT: "3306"
