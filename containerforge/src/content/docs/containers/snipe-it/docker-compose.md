...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0bc08bc06a4d12b70ff310db27e70c0eWORD
      MARIADB_ROOT_PASSWORD: b63e6a75720f31260ae49571e17f3749WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0bc08bc06a4d12b70ff310db27e70c0eWORD
      DB_PORT: "3306"
