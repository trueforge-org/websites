...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8c4ac95ee10b3e230fe20c302ef3bceeWORD
      MARIADB_ROOT_PASSWORD: e05f8d4f146549f3fa33a9eee2feca00WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8c4ac95ee10b3e230fe20c302ef3bceeWORD
      DB_PORT: "3306"
