...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fde5c9aa2dde174a5b6ac5a0cce58e66WORD
      MARIADB_ROOT_PASSWORD: 4150e084d3e6971c678d4f32bf2143bcWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fde5c9aa2dde174a5b6ac5a0cce58e66WORD
      DB_PORT: "3306"
