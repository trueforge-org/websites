...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 226273eb5adef4cb1184bd63ecef60fcWORD
      MARIADB_ROOT_PASSWORD: f6b2b5e608a07f45c6e756b1e12f23b8WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 226273eb5adef4cb1184bd63ecef60fcWORD
      DB_PORT: "3306"
