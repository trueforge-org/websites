...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ae129d4b1ec4f5a1e2093289f110de58WORD
      MARIADB_ROOT_PASSWORD: 3a111d549291dddd43175c6c455a92e4WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ae129d4b1ec4f5a1e2093289f110de58WORD
      DB_PORT: "3306"
