...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fa2d0e73031758afa3e6971d9889c99fWORD
      MARIADB_ROOT_PASSWORD: c4ea0729291bf05fd580956718155b8dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fa2d0e73031758afa3e6971d9889c99fWORD
      DB_PORT: "3306"
