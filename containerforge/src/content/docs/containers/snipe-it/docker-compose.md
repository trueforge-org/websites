...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: aca514ab17989216bcd4fcc8d7008f6dWORD
      MARIADB_ROOT_PASSWORD: d5a774e1e8594f8dbc2edabe16fbe251WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: aca514ab17989216bcd4fcc8d7008f6dWORD
      DB_PORT: "3306"
