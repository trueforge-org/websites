...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 749b64a7162958c7a1a12279b505c046WORD
      MARIADB_ROOT_PASSWORD: cf94c81cdc4a125236773df5da71fb11WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 749b64a7162958c7a1a12279b505c046WORD
      DB_PORT: "3306"
