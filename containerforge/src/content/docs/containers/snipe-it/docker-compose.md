...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 15b08966644c058d811a8c9d9e1099bcWORD
      MARIADB_ROOT_PASSWORD: eaba068d2f8fcc2c1651496126dccdbbWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 15b08966644c058d811a8c9d9e1099bcWORD
      DB_PORT: "3306"
