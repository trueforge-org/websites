...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d2bb84b5146a0b76b162c965c694567cWORD
      MARIADB_ROOT_PASSWORD: 18a56ce629308cc404940c96411dfc15WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d2bb84b5146a0b76b162c965c694567cWORD
      DB_PORT: "3306"
