...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 272fc89903fba13ff197b3887f31c50eWORD
      MARIADB_ROOT_PASSWORD: 0d35ef5ba039d569fb352d4eaeb9f567WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 272fc89903fba13ff197b3887f31c50eWORD
      DB_PORT: "3306"
