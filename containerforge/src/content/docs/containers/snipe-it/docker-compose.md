...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2fe45f12ef002a3cdc3312a504f1031dWORD
      MARIADB_ROOT_PASSWORD: 6d9f078dbc367f0ae7670bc46ede0f85WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2fe45f12ef002a3cdc3312a504f1031dWORD
      DB_PORT: "3306"
