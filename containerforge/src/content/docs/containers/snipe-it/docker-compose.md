...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7a8d6cac606119d3244a8ceadfdff75dWORD
      MARIADB_ROOT_PASSWORD: c6a71908e2bc285e7f721e30d6384f1aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7a8d6cac606119d3244a8ceadfdff75dWORD
      DB_PORT: "3306"
