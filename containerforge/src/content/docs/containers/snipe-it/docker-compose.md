...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 13e78c0004f1df78735de34cb9abef9dWORD
      MARIADB_ROOT_PASSWORD: 05aa75e2e3ad1466fea27215deafce84WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 13e78c0004f1df78735de34cb9abef9dWORD
      DB_PORT: "3306"
