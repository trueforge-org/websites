...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 02ef7404d4faed80562fb0b59127b2b9WORD
      MARIADB_ROOT_PASSWORD: 6d5e252b1f60a344aa2a0de16dce4d26WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 02ef7404d4faed80562fb0b59127b2b9WORD
      DB_PORT: "3306"
