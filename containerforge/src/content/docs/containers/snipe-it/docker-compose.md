...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 022eb8498c87f936ef3dab008d7af507WORD
      MARIADB_ROOT_PASSWORD: 503aa8898a1ae8377bb4f8910326d90bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 022eb8498c87f936ef3dab008d7af507WORD
      DB_PORT: "3306"
