...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9df7c2c8e9b4fd0d3a30786a2f0fb459WORD
      MARIADB_ROOT_PASSWORD: 639efd55aa8cd218d1503ebe8bbc336cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9df7c2c8e9b4fd0d3a30786a2f0fb459WORD
      DB_PORT: "3306"
