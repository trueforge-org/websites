...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b51f983d3ff31a74c4a7eb1e92a251dfWORD
      MARIADB_ROOT_PASSWORD: fa191aa78a0adc14dbf8971e02db3e96WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b51f983d3ff31a74c4a7eb1e92a251dfWORD
      DB_PORT: "3306"
