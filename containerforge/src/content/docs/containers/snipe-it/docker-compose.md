...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f5d863cc1557be3c520046c29dd209deWORD
      MARIADB_ROOT_PASSWORD: d3119ec4e012bce11b62f36c0eb2811aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f5d863cc1557be3c520046c29dd209deWORD
      DB_PORT: "3306"
