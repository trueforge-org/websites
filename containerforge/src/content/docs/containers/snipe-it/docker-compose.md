...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5e55bcb85c1246bcfe90eec9ecf5a556WORD
      MARIADB_ROOT_PASSWORD: 25df12621d9ab5a5d143d6c052b0d47cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5e55bcb85c1246bcfe90eec9ecf5a556WORD
      DB_PORT: "3306"
