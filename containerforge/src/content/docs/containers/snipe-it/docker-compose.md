...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1afc38109ebf28516d381a1d34dc4207WORD
      MARIADB_ROOT_PASSWORD: 0506f1b429fab83e0c2d17bad84ad8a4WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1afc38109ebf28516d381a1d34dc4207WORD
      DB_PORT: "3306"
