...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7a6a58ab890fb586422e8fdafd28544aWORD
      MARIADB_ROOT_PASSWORD: dc19685254cdcb49e7b47efbf864dcf3WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7a6a58ab890fb586422e8fdafd28544aWORD
      DB_PORT: "3306"
