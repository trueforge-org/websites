...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a6ec6601570a7ac4d002451694d0dc46WORD
      MARIADB_ROOT_PASSWORD: 4ae6b4af09a884b42ea81224809431b0WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a6ec6601570a7ac4d002451694d0dc46WORD
      DB_PORT: "3306"
