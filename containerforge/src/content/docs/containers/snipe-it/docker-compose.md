...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cf73efdc6b641b71e5e020a4b7e882cfWORD
      MARIADB_ROOT_PASSWORD: 09d45696806dcbf10d8c1291d4d63663WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cf73efdc6b641b71e5e020a4b7e882cfWORD
      DB_PORT: "3306"
