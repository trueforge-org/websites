...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cce8568a0011c63d83b07147ab9ea017WORD
      MARIADB_ROOT_PASSWORD: 00d177f97f8eefdda3a9e555a7c9c2bdWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cce8568a0011c63d83b07147ab9ea017WORD
      DB_PORT: "3306"
