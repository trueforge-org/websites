...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a8bf81dd90e96bc05e5358c2a1ef20ceWORD
      MARIADB_ROOT_PASSWORD: 59d117e3af20ba046ff99ff7b953d045WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a8bf81dd90e96bc05e5358c2a1ef20ceWORD
      DB_PORT: "3306"
