...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ab2be4127184d7946c7cbfff7e000291WORD
      MARIADB_ROOT_PASSWORD: 9875269ea06cccb5f168200ae81fbddfWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ab2be4127184d7946c7cbfff7e000291WORD
      DB_PORT: "3306"
