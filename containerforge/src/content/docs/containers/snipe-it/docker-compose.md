...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5b879214d81fcb4212298e3f46b12a10WORD
      MARIADB_ROOT_PASSWORD: c7a18c45a7c4961d56527d624983c663WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5b879214d81fcb4212298e3f46b12a10WORD
      DB_PORT: "3306"
