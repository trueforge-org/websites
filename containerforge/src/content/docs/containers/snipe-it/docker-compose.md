...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4b1cef2d3b80607c9ce6a5e9ce7fa712WORD
      MARIADB_ROOT_PASSWORD: 7ad322d076df8e6ed97d4709bad05ab5WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4b1cef2d3b80607c9ce6a5e9ce7fa712WORD
      DB_PORT: "3306"
