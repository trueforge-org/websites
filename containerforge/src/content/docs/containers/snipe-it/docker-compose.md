...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e1da4da120535d01ecee5d86db54f40bWORD
      MARIADB_ROOT_PASSWORD: 11e0824ff35f4c678c960c68dfaac799WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e1da4da120535d01ecee5d86db54f40bWORD
      DB_PORT: "3306"
