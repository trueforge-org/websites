...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 67326a63173e9cadeda945c3b12072b9WORD
      MARIADB_ROOT_PASSWORD: 0eae710b83471b3daae107f8b2ab8027WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 67326a63173e9cadeda945c3b12072b9WORD
      DB_PORT: "3306"
