...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 929b48a3ab00fbb86b564406745390a6WORD
      MARIADB_ROOT_PASSWORD: d685fbdd06afe4deb86703ea6bd7cda6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 929b48a3ab00fbb86b564406745390a6WORD
      DB_PORT: "3306"
