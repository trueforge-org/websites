...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f9346f4b567eb3b6ba65f5daa2a9e68cWORD
      MARIADB_ROOT_PASSWORD: 57acf3a6ac6b8faa9b0e9f2a4f67f1d2WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f9346f4b567eb3b6ba65f5daa2a9e68cWORD
      DB_PORT: "3306"
