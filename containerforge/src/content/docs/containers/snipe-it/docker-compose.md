...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 68b0c180e6b7076afa5a20ea3fddd6b3WORD
      MARIADB_ROOT_PASSWORD: b5ecaeaea1afc69e7cc159dae822ba40WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 68b0c180e6b7076afa5a20ea3fddd6b3WORD
      DB_PORT: "3306"
