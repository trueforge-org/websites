...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e6edfe4ca4b9db03ef12d1f19c245433WORD
      MARIADB_ROOT_PASSWORD: 5f24901632c9e23419fec68d57ffa38dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e6edfe4ca4b9db03ef12d1f19c245433WORD
      DB_PORT: "3306"
