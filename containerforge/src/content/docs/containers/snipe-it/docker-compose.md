...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d2e32c58de79e93945e56df92af75780WORD
      MARIADB_ROOT_PASSWORD: e3787c2c887fe4a816695e403997e70cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d2e32c58de79e93945e56df92af75780WORD
      DB_PORT: "3306"
