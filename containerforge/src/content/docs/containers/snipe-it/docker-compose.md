...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bdc08bb4a9717fd1a658f8cb3ef1e098WORD
      MARIADB_ROOT_PASSWORD: 25aecafee252404d55d27e305306e462WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bdc08bb4a9717fd1a658f8cb3ef1e098WORD
      DB_PORT: "3306"
