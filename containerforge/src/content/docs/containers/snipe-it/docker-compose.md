...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 412234b321bdca8a4df33b242f781beaWORD
      MARIADB_ROOT_PASSWORD: fe1fb803d0320e0f22a746f6bc777f92WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 412234b321bdca8a4df33b242f781beaWORD
      DB_PORT: "3306"
