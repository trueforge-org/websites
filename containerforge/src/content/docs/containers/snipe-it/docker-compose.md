...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6159c3f18058fe992fd4131db1c48d17WORD
      MARIADB_ROOT_PASSWORD: c4101b600a476059ae92e9ae01a02336WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6159c3f18058fe992fd4131db1c48d17WORD
      DB_PORT: "3306"
