...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e2d2d483996e5e9365e65fbaf949fd57WORD
      MARIADB_ROOT_PASSWORD: fa6b546460c90b492934b7bd0b7e2773WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e2d2d483996e5e9365e65fbaf949fd57WORD
      DB_PORT: "3306"
