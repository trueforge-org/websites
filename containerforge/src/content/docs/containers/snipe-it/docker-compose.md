...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f4c43e635397e9a850ae085506adfc5fWORD
      MARIADB_ROOT_PASSWORD: ebc76faddbd8ee2673e72f0589a0f750WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f4c43e635397e9a850ae085506adfc5fWORD
      DB_PORT: "3306"
