...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 77b7712f6960c0c5956f20544e8d9e34WORD
      MARIADB_ROOT_PASSWORD: f776149067a685ad09a0feff72d25500WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 77b7712f6960c0c5956f20544e8d9e34WORD
      DB_PORT: "3306"
