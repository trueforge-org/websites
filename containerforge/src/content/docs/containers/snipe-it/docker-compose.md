...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4378ea8989b307c0be25f06a8e8b1af3WORD
      MARIADB_ROOT_PASSWORD: e0bb13df70362926195e222800d0d361WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4378ea8989b307c0be25f06a8e8b1af3WORD
      DB_PORT: "3306"
