...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: db4823e333a23da2d09764a6c127a434WORD
      MARIADB_ROOT_PASSWORD: 9711984b4fc11a61718ffb29e0987fa7WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: db4823e333a23da2d09764a6c127a434WORD
      DB_PORT: "3306"
