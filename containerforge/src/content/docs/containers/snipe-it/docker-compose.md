...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cb262eb39c432de6f25267bc079d3fb9WORD
      MARIADB_ROOT_PASSWORD: 1a6b15309bc6745a842e9e505a6afb8fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cb262eb39c432de6f25267bc079d3fb9WORD
      DB_PORT: "3306"
