...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f68245a2b8bac58eab3733f03e28c086WORD
      MARIADB_ROOT_PASSWORD: 978491b30387f7ed3b408e133bc77a6eWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f68245a2b8bac58eab3733f03e28c086WORD
      DB_PORT: "3306"
