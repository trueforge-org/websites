...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6e17b987afb3b10fda5890a3cf9f1532WORD
      MARIADB_ROOT_PASSWORD: 33389e6ab86cdeac5f892257a2b64d9bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6e17b987afb3b10fda5890a3cf9f1532WORD
      DB_PORT: "3306"
