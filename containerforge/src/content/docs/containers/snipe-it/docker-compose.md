...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 86186b1c5edba001c5d02aab8e6bf3a5WORD
      MARIADB_ROOT_PASSWORD: 8f164fdddcc3bedb39ba33159dd26495WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 86186b1c5edba001c5d02aab8e6bf3a5WORD
      DB_PORT: "3306"
