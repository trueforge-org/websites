...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f1aef0f110cb5e7846e83be6a2a85835WORD
      MARIADB_ROOT_PASSWORD: 8829239bc59e646d25f9cca84d220ddfWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f1aef0f110cb5e7846e83be6a2a85835WORD
      DB_PORT: "3306"
