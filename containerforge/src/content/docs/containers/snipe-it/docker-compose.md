...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e26e8fe99d2f43869902a2fdcbb2983cWORD
      MARIADB_ROOT_PASSWORD: 061cec97913461543f6b58b7e74f2bcdWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e26e8fe99d2f43869902a2fdcbb2983cWORD
      DB_PORT: "3306"
