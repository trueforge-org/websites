...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 33df594ace8c2b5520e8b08e4705432cWORD
      MARIADB_ROOT_PASSWORD: 65e8ad89e08f9fb2f03a6788cdb866a6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 33df594ace8c2b5520e8b08e4705432cWORD
      DB_PORT: "3306"
