...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 538cf41b52d0d60c5c6ee3dd58eac955WORD
      MARIADB_ROOT_PASSWORD: 62bdec4b346eada0e7da0f1ec04e5d6dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 538cf41b52d0d60c5c6ee3dd58eac955WORD
      DB_PORT: "3306"
