...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3ff76cc865eff5cb91993b5bbbad86a0WORD
      MARIADB_ROOT_PASSWORD: 6167fe44b8ede66a48177e68ccd1d960WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3ff76cc865eff5cb91993b5bbbad86a0WORD
      DB_PORT: "3306"
