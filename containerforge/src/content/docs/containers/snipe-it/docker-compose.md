...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a4b9a59dbb2641e42c8aea52da5fa482WORD
      MARIADB_ROOT_PASSWORD: 5c53baf64ba60f689336e877f725cc1cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a4b9a59dbb2641e42c8aea52da5fa482WORD
      DB_PORT: "3306"
