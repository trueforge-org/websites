...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 54577e0f5e898519f252fcbc84297d94WORD
      MARIADB_ROOT_PASSWORD: 0e986b8d4defed813349a4482dc65248WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 54577e0f5e898519f252fcbc84297d94WORD
      DB_PORT: "3306"
