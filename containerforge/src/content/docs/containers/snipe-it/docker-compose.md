...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d629ba23916b9bb0e6ff722d8f07343bWORD
      MARIADB_ROOT_PASSWORD: a6d933f805d594d131e7a90a640d9925WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d629ba23916b9bb0e6ff722d8f07343bWORD
      DB_PORT: "3306"
