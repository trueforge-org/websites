...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9fba802f53fc8640dfd64312cc767ceeWORD
      MARIADB_ROOT_PASSWORD: 02080af1b8664cbda07f45fac82e09d8WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9fba802f53fc8640dfd64312cc767ceeWORD
      DB_PORT: "3306"
