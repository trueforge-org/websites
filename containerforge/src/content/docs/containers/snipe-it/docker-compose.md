...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 18ea62acd0d8fa1cae8e94ac73b84dfaWORD
      MARIADB_ROOT_PASSWORD: 1ad00d9626499f7b820380c7f88adfcbWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 18ea62acd0d8fa1cae8e94ac73b84dfaWORD
      DB_PORT: "3306"
