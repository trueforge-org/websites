...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fd681f3a9a481238045aaa0a7028fd8bWORD
      MARIADB_ROOT_PASSWORD: a1f69c2e303cca130964dd686db535dbWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fd681f3a9a481238045aaa0a7028fd8bWORD
      DB_PORT: "3306"
