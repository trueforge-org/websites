...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f8a352229088e522f5cf43812a63feceWORD
      MARIADB_ROOT_PASSWORD: acf83e17ea8a8f3627b044f52adc005cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f8a352229088e522f5cf43812a63feceWORD
      DB_PORT: "3306"
