...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: eeea76ef1b99d2e0280106ea9df74d76WORD
      MARIADB_ROOT_PASSWORD: 29bcba26f9f4d14c3806c687f30ecd52WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: eeea76ef1b99d2e0280106ea9df74d76WORD
      DB_PORT: "3306"
