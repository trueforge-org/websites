...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b00131c8e5c1d1c4e86ad59fb6aa7678WORD
      MARIADB_ROOT_PASSWORD: befbf26f0627b21651f473e35d4cbaf2WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b00131c8e5c1d1c4e86ad59fb6aa7678WORD
      DB_PORT: "3306"
