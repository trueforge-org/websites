...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bcbf0bbc043c61a2d5e8e3b353c0267aWORD
      MARIADB_ROOT_PASSWORD: b15f70bd67abe9c07a3d74833e14879cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bcbf0bbc043c61a2d5e8e3b353c0267aWORD
      DB_PORT: "3306"
