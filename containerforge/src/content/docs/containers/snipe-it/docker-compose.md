...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e357df63238fcb9ea6d922ab06412dc0WORD
      MARIADB_ROOT_PASSWORD: cd742ab96be66f112616985908c66625WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e357df63238fcb9ea6d922ab06412dc0WORD
      DB_PORT: "3306"
