...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 148727d1d3aec7eef94fa2181c0d76ecWORD
      MARIADB_ROOT_PASSWORD: 14f4e1e7c73fc3c83593dac9f2f96a81WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 148727d1d3aec7eef94fa2181c0d76ecWORD
      DB_PORT: "3306"
