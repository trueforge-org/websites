...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0e659366a08b6db7b0d88ece211ea452WORD
      MARIADB_ROOT_PASSWORD: d3811169f1e7f034e1d8ae432478ce3bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0e659366a08b6db7b0d88ece211ea452WORD
      DB_PORT: "3306"
