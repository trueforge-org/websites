...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 18bd55fb5ead9307efe5bd7456053db3WORD
      MARIADB_ROOT_PASSWORD: 1638b4291ae6678f88bd1062ce54e3e5WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 18bd55fb5ead9307efe5bd7456053db3WORD
      DB_PORT: "3306"
