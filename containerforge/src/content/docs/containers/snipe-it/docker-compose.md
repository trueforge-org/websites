...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 70a344a10bd715f2b61b5992f3ad9453WORD
      MARIADB_ROOT_PASSWORD: fbe9be4c809763af4b5ed6ee19f24b39WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 70a344a10bd715f2b61b5992f3ad9453WORD
      DB_PORT: "3306"
