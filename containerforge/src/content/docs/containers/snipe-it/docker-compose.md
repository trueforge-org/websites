...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0326b158df2c19f430dfe230d72e7fcfWORD
      MARIADB_ROOT_PASSWORD: a9197631d70d475a14719e2356b1c348WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0326b158df2c19f430dfe230d72e7fcfWORD
      DB_PORT: "3306"
