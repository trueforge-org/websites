...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3c4e638cc4c9a1e5e6807e11cda84b17WORD
      MARIADB_ROOT_PASSWORD: 9d582ea5c6e25f6a0a4dec8151c9cdafWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3c4e638cc4c9a1e5e6807e11cda84b17WORD
      DB_PORT: "3306"
