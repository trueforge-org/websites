...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d1f0c0b79394f04b05fd522dfc16d150WORD
      MARIADB_ROOT_PASSWORD: aa4510df018e4c6257b9726ab7215fc9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d1f0c0b79394f04b05fd522dfc16d150WORD
      DB_PORT: "3306"
