...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 26bf551b89dbd118e3850ddd17563588WORD
      MARIADB_ROOT_PASSWORD: 67361dcf25417ada6728e549eaaf31a9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 26bf551b89dbd118e3850ddd17563588WORD
      DB_PORT: "3306"
