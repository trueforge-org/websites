...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 44b83c83b18e481f9fc80932a71b21baWORD
      MARIADB_ROOT_PASSWORD: 545d873fa8323fce2b7718c560ca3983WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 44b83c83b18e481f9fc80932a71b21baWORD
      DB_PORT: "3306"
