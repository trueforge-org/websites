...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 22cd91e236bf929ec4ee81c068af87b5WORD
      MARIADB_ROOT_PASSWORD: cd2f28a4845027021483e7f4316c6d75WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 22cd91e236bf929ec4ee81c068af87b5WORD
      DB_PORT: "3306"
