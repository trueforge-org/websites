...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6e2d160b102042678abffeca34a8b862WORD
      MARIADB_ROOT_PASSWORD: ac185e24f347c347b8d912db67a9cb02WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6e2d160b102042678abffeca34a8b862WORD
      DB_PORT: "3306"
