...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4a544792cc978a45b9b22f2de9d41578WORD
      MARIADB_ROOT_PASSWORD: cb94f4f141eef2f7a4c4e06e737f81a9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4a544792cc978a45b9b22f2de9d41578WORD
      DB_PORT: "3306"
