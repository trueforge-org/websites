...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b7b5b174b7a60be950e2ddd14ef1be58WORD
      MARIADB_ROOT_PASSWORD: a5c4c1d1098f4ba0ece9085d2368f1c0WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b7b5b174b7a60be950e2ddd14ef1be58WORD
      DB_PORT: "3306"
