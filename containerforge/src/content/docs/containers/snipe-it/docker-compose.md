...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4e14adab6936d7b4ac09b841cd226d9fWORD
      MARIADB_ROOT_PASSWORD: 3412fe283254293ffcbeb6fd6f3577ceWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4e14adab6936d7b4ac09b841cd226d9fWORD
      DB_PORT: "3306"
