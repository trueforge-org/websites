...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ed14e2da49be45f4c0b883864dd2b2e5WORD
      MARIADB_ROOT_PASSWORD: b0ba73d2cea7f441751425ca3eaa9083WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ed14e2da49be45f4c0b883864dd2b2e5WORD
      DB_PORT: "3306"
