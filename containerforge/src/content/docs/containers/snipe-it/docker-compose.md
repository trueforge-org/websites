...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 845471beba16d6e0f09176c94abe42a0WORD
      MARIADB_ROOT_PASSWORD: 637ae05616beb21b1b30bc942404fe2fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 845471beba16d6e0f09176c94abe42a0WORD
      DB_PORT: "3306"
