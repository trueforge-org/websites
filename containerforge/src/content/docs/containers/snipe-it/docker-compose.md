...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9c2e939174a456e0c792855a70a6580dWORD
      MARIADB_ROOT_PASSWORD: 80092a6d5f1eda5b6d2b2ddc45b629caWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9c2e939174a456e0c792855a70a6580dWORD
      DB_PORT: "3306"
