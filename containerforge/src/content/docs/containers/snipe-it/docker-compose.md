...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 42bdc7f015916ba0f6f5bee6c365ac87WORD
      MARIADB_ROOT_PASSWORD: f9d8e3b812297653548e91a93749cf0fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 42bdc7f015916ba0f6f5bee6c365ac87WORD
      DB_PORT: "3306"
