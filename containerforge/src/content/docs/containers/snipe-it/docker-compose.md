...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 33334cd348b1e02da585d9398b045da8WORD
      MARIADB_ROOT_PASSWORD: 825756784cac7768439ab5d4a274b8ceWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 33334cd348b1e02da585d9398b045da8WORD
      DB_PORT: "3306"
