...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d74d992e66cfc48a02dfdc601d3cdfefWORD
      MARIADB_ROOT_PASSWORD: be3007549ee16b9cbe5c35331cf7837fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d74d992e66cfc48a02dfdc601d3cdfefWORD
      DB_PORT: "3306"
