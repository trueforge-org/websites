...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4d8906ffa65e6232d1920284b252550bWORD
      MARIADB_ROOT_PASSWORD: 2a7aed24e9f5d1964e59d5ac990f87d9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4d8906ffa65e6232d1920284b252550bWORD
      DB_PORT: "3306"
