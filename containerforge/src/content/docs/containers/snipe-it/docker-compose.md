...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0c46b008e0a7b08622f3eeb39ac903c4WORD
      MARIADB_ROOT_PASSWORD: 3e9dffa17439cca45cecb46109b60f29WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0c46b008e0a7b08622f3eeb39ac903c4WORD
      DB_PORT: "3306"
