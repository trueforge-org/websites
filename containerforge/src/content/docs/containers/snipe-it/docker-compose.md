...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1ee8c6c42e62395960405a09ab96cff2WORD
      MARIADB_ROOT_PASSWORD: 506143c1c16ad17ab5770ff8758a946dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1ee8c6c42e62395960405a09ab96cff2WORD
      DB_PORT: "3306"
