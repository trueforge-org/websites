...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 152735b80cb4692b7697eddd3fa12cf3WORD
      MARIADB_ROOT_PASSWORD: 4f1116fba0b0d0cfd62249013aeb2a30WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 152735b80cb4692b7697eddd3fa12cf3WORD
      DB_PORT: "3306"
