...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f998bf7c3058bb352d73efd466017f24WORD
      MARIADB_ROOT_PASSWORD: e73b341005566843a0834e66fdac6d9dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f998bf7c3058bb352d73efd466017f24WORD
      DB_PORT: "3306"
