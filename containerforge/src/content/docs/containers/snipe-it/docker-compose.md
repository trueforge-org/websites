...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 73f4b59d7fcda110a3d4d89208579076WORD
      MARIADB_ROOT_PASSWORD: ea6a343886520e951791d8d48f20eab9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 73f4b59d7fcda110a3d4d89208579076WORD
      DB_PORT: "3306"
