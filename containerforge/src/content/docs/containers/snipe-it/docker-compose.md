...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 52f230927ab22ebc771c4a137e588e75WORD
      MARIADB_ROOT_PASSWORD: 83baa4110ad01f7a35e4b0abc962b3d5WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 52f230927ab22ebc771c4a137e588e75WORD
      DB_PORT: "3306"
