...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 20c12c9ee1fc938a6a0ee16c06f6e3eeWORD
      MARIADB_ROOT_PASSWORD: 9fde14aacf9f7ab56b72ee84dd0c84f3WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 20c12c9ee1fc938a6a0ee16c06f6e3eeWORD
      DB_PORT: "3306"
