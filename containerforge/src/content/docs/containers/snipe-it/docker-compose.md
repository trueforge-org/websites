...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2e88d916ef9e943f11500c822d161db4WORD
      MARIADB_ROOT_PASSWORD: 0cde7759cd20fd046ca1a4297677823fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2e88d916ef9e943f11500c822d161db4WORD
      DB_PORT: "3306"
