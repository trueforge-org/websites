...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1775a6b557e3c3b1fef86c76b7248397WORD
      MARIADB_ROOT_PASSWORD: cd65fd5506ee383c9746324ca45054a9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1775a6b557e3c3b1fef86c76b7248397WORD
      DB_PORT: "3306"
