...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f8a7c53e81708d9aaef3b0bc90e34cccWORD
      MARIADB_ROOT_PASSWORD: a4f967e8d9eef9e2f75bce9db0cd3474WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f8a7c53e81708d9aaef3b0bc90e34cccWORD
      DB_PORT: "3306"
